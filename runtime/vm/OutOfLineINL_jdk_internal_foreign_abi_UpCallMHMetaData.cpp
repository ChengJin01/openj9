...
OutOfLineINL_jdk_internal_foreign_abi_UpcallMHMetaData_resolveUpcallDataFields(J9VMThread *currentThread, J9Method *method)
{
	...
	U_16 cpIndex[cpEntryNum] = {
			...
			J9VMCONSTANTPOOL_JDKINTERNALFOREIGNABIUPCALLMHMETADATA_CALLEETYPE,
			...
			J9VMCONSTANTPOOL_JDKINTERNALFOREIGNMEMORYADDRESSIMPL_SEGMENT, // removed from MemoryAddressImpl since Java 18
			...
			J9VMCONSTANTPOOL_JDKINTERNALFOREIGNCONFINEDSESSION_OWNER
#else /* JAVA_SPEC_VERSION >= 19 */
			J9VMCONSTANTPOOL_JDKINTERNALFOREIGNNATIVEMEMORYSEGMENTIMPL_SCOPE,
			J9VMCONSTANTPOOL_JDKINTERNALFOREIGNCONFINEDSCOPE_OWNER
