...
/**
 * jdk.internal.foreign.abi.ProgrammableUpcallHandler: private native long allocateUpcallStub(MethodHandle calleeMH, UpcallMHMetaData mhMetaData, String[] cSignatureStrs);
 *
...
OutOfLineINL_jdk_internal_foreign_abi_ProgrammableUpcallHandler_allocateUpcallStub(J9VMThread *currentThread, J9Method *method)
{
	...
	calleeHandle = J9_JNI_UNWRAP_REFERENCE(currentThread->sp + 2);
	upcallMetaData->calleeMH = j9jni_createGlobalRef((JNIEnv*)currentThread, calleeHandle, false);
	...
	VM_OutOfLineINL_Helpers::returnDouble(currentThread, (intptr_t)thunkAddr, 4);
	return rc;
