...
OutOfLineINL_jdk_internal_foreign_abi_ProgrammableUpcallHandler_allocateUpcallStub(J9VMThread *currentThread, J9Method *method)
{
	 ...
	 */
	//VM_OutOfLineINL_Helpers::buildGenericSpecialStackFrame(currentThread, 0);
	VM_OutOfLineINL_Helpers::buildInternalNativeStackFrame(currentThread, method);
	VM_OutOfLineINL_Helpers::updateVMStruct(currentThread, &thread);
	...
	VM_OutOfLineINL_Helpers::VMStructHasBeenUpdated(currentThread, &thread);
	if (VM_VMHelpers::exceptionPending(currentThread)) {
		rc = GOTO_THROW_CURRENT_EXCEPTION;
		goto freeAllMemoryThenExit;
	}
	VM_OutOfLineINL_Helpers::restoreInternalNativeStackFrame(currentThread);
	//VM_OutOfLineINL_Helpers::restoreGenericSpecialStackFrame(currentThread);
