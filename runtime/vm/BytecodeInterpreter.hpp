...
ffi_OOM:
	...
	native2InterpreterTransition(REGISTER_ARGS_LIST)
	{
		...
		/* Clean the JIT specific flags to avoid jumping over to an invalid JIT return address
		 * upon return as the callin doesn't come from JIT but the generated thunk.
		 */
		_currentThread->jitStackFrameFlags = 0;
