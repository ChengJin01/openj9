...
foundITable:
	...
	linkToNative(REGISTER_ARGS_LIST)
	{
		...
		/* Pop up the dummy argument (the placeholder for the method type of the bounded MH)
		...
		/* The cache array stores the data (memberName & appendix) for the bounded handle which
