...
int
addLongAndLong2FloatsFromStruct(LONG arg1, stru_Long_2_Floats arg2)
{
	printf("\n internal: addLongAndLong2FloatsFromStruct: arg1 = %lld", arg1);
	printf("\n internal: addLongAndLong2FloatsFromStruct: arg2.elem1 = %lld", arg2.elem1);
	printf("\n internal: addLongAndLong2FloatsFromStruct: arg2.elem2 = %f", arg2.elem2);
	printf("\n internal: addLongAndLong2FloatsFromStruct: arg2.elem3 = %f\n", arg2.elem3);
	return 1;
}
...
{
	  UDATA returnValue = 0;
	  UDATA *returnStorageTest = &returnValue;
	  ffi_cif cif_temp;
	  UDATA structElemNum = 3;
	  UDATA argNum = 2;
	  ...
	  ffi_type cls_struct_type1;
	  ffi_type *retType = &ffi_type_sint32;
	  long arg1;
	  stru_Long_2_Floats arg2;

	  cls_struct_fields1[0] = &ffi_type_sint64;
	...
	ffi_call(&cif_temp, FFI_FN(addLongAndLong2FloatsFromStruct), returnStorageTest, args_db);
	printf("\nffi_call1: returnStorageTest = %d, returnValue = %d\n", (int)(*returnStorageTest), (int)returnValue);
