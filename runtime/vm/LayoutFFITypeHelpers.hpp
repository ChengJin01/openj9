...
public:
	 ...
	 * 		If layout is "16#2[#2[II]#2[II]]", it becomes "#2[#2[II]#2[II]]" and returns 16
	...
	getPrimitiveFFIType(char layoutSymb)
	{
		...
		case 'I':	/* C_INT */
			...
			break;
		case 'L':	/* either C_LONG or C_LONG_LONG */
	...
	getLayoutFFIType(ffi_type** typeFFI, j9object_t layoutStringObject) {
		...
		*typeFFI = NULL;
		...
		//printf("\ngetLayoutFFIType: layoutSize = %lu, layoutTemp = %s", layoutSize, layoutTemp);
