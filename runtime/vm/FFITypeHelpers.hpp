...
doneGetArrayFFIType:
	 ...
	 */
	VMINLINE ffi_type*
	mapLayoutToPrimitiveFFIType(j9object_t layoutStringObject) {
		PORT_ACCESS_FROM_JAVAVM(_vm);
		...
		primitiveTypeFFI = getPrimitiveFFIType(*(++currentLayout));

doneGetPrimitiveFFIType:
