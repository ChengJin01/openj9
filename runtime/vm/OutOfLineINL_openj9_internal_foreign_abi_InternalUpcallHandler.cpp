...
OutOfLineINL_openj9_internal_foreign_abi_InternalUpcallHandler_allocateUpcallStub(J9VMThread *currentThread, J9Method *method)
{
	...
	invokeCache = resolveFfiCallInvokeHandle(currentThread,
			J9VMOPENJ9INTERNALFOREIGNABIUPCALLMHMETADATA_CALLEEMH(currentThread,
	...
	J9VMOPENJ9INTERNALFOREIGNABIUPCALLMHMETADATA_SET_INVOKECACHE(currentThread,
			J9_JNI_UNWRAP_REFERENCE(upcallMetaData->mhMetaData), invokeCache);
