 ...
 * @param upcallMH the function pobooler to the upcall method
 * @return the XOR result of booleans
 */
bool
...
/**
 * Get a pobooler to struct by adding each boolean element of two structs
 * with the XOR (^) operator by invoking a upcall method.
 *
 * @param arg1 a pobooler to the 1st struct with two booleans
 * @param arg2 the 2nd struct with two booleans
 * @param upcallMH the function pobooler to the upcall method
 * @return a pobooler to struct with two booleans
 */
stru_Bool_Bool *
add2BoolStructsWithXor_returnStructPoboolerByUpcallMH(stru_Bool_Bool *arg1, stru_Bool_Bool arg2, stru_Bool_Bool * (*upcallMH)(stru_Bool_Bool *, stru_Bool_Bool))
{
	arg1 = (*upcallMH)(arg1, arg2);
	return arg1;
}
