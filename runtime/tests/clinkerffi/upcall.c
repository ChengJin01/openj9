...
/**
 * Add two ints by invoking a upcall method.
 *
...
/**
 * Add two ints (the 2nd one is assigned in native) by invoking a upcall method.
 *
 * @param intArg1 the 1st int
 * @param upcallMH the function pointer to the upcall method
 * @return the sum
...
/**
 * Add three ints by invoking a upcall method.
 *
 * @param intArg1 the 1st int
 * @param intArg2 the 2nd int
...
/**
 * Add an int and a char by invoking a upcall method.
 *
 * @param intArg an int
...
/**
 * Add two ints without return value by invoking a upcall method.
 *
 * @param intArg1 the 1st int
 * @param intArg2 the 2nd int
 * @param upcallMH the function pointer to the upcall method
 ...
 * three booleans by invoking a upcall method.
 *
...
/**
 * Add a byte and 20 bytes of a struct by invoking a upcall method.
 *
 * @param arg1 a byte
...
/**
 * Add a short and 10 shorts of a struct by invoking a upcall method.
 *
 * @param arg1 a short
 ...
 * and an int by invoking a upcall method.
 *
 * @param arg1 an int
 ...
 * nested int array (in reverse order) by invoking a upcall method.
 *
 * @param arg1 an int
...
/**
 * Add a float and 5 floats of a struct by invoking a upcall method.
 *
 * @param arg1 a float
...
{
	int intSum = (*upcallMH)(argCount, intVaList);
	return intSum;
}
...
{
	double doubleSum = (*upcallMH)(argCount, doubleVaList);
	return doubleSum;
}
 ...
 * with the specified count by invoking a upcall method.
 *
...
/**
 * Add ints (accessed via MemorySegment in java) from the va_list
 * with the specified count by invoking a upcall method.
 *
 ...
 */
int
addIntsByStructFromVaListByUpcallMH(int argCount, va_list struVaList, int (*upcallMH)(int, va_list))
{
...
/**
 * Add longs (accessed via MemorySegment in java) from the va_list
 * with the specified count by invoking a upcall method.
 *
 * @param argCount the count of struct in the va_list
 * @param struVaList the passed-in va_list containing structs
 ...
 */
LONG
addLongsByStructFromVaListByUpcallMH(int argCount, va_list struVaList, LONG (*upcallMH)(int, va_list))
{
...
/**
 * Add doubles (accessed via MemorySegment in java) from the va_list
 * with the specified count by invoking a upcall method.
 *
 * @param argCount the count of struct in the va_list
 * @param struVaList the passed-in va_list containing structs
 ...
 */
double
addDoublesByStructFromVaListByUpcallMH(int argCount, va_list struVaList, double (*upcallMH)(int, va_list))
{
