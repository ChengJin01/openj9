...
typedef struct stru_20_Bools stru_20_Bools;
...
typedef struct stru_Bool_NestedBoolArray stru_Bool_NestedBoolArray;
...
typedef struct stru_10_Chars stru_10_Chars;
...
typedef struct stru_Char_NestedCharArray stru_Char_NestedCharArray;
...
typedef struct stru_10_Shorts stru_10_Shorts;
...
typedef struct stru_Short_NestedShortArray stru_Short_NestedShortArray;
...
typedef struct stru_5_Ints stru_5_Ints;
...
typedef struct stru_Int_NestedIntArray stru_Int_NestedIntArray;
...
typedef struct stru_Long_NestedLongArray stru_Long_NestedLongArray;
...
typedef struct stru_5_Floats stru_5_Floats;
...
typedef struct stru_Float_NestedFloatArray stru_Float_NestedFloatArray;
...
typedef struct stru_Double_NestedDoubleArray stru_Double_NestedDoubleArray;
typedef struct stru_NestedStruArray_Double stru_NestedStruArray_Double;
typedef struct stru_Double_NestedStruArray stru_Double_NestedStruArray;
...
typedef struct stru_Int_Double stru_Int_Double;
typedef struct stru_Double_Int stru_Double_Int;
typedef struct stru_Float_Double stru_Float_Double;
typedef struct stru_Double_Float stru_Double_Float;
typedef struct stru_Float_Float_Double stru_Float_Float_Double;
typedef struct stru_Double_Float_Float stru_Double_Float_Float;
typedef struct stru_Int_Float_Float stru_Int_Float_Float;
typedef struct stru_Float_Int_Float stru_Float_Int_Float;
typedef struct stru_Int_Float_Double stru_Int_Float_Double;
typedef struct stru_Float_Int_Double stru_Float_Int_Double;
typedef struct stru_Long_Double stru_Long_Double;
typedef struct stru_Int_3_Floats stru_Int_3_Floats;
typedef struct stru_Long_2_Floats stru_Long_2_Floats;
typedef struct stru_3_Floats_Int stru_3_Floats_Int;
typedef struct stru_Float_Long stru_Float_Long;
typedef struct stru_Double_Float_Int stru_Double_Float_Int;
typedef struct stru_Double_Long stru_Double_Long;
typedef struct stru_Float_Float_Long stru_Float_Float_Long;
typedef struct stru_3_Shorts_Char stru_3_Shorts_Char;
typedef struct stru_Int_Float_Int_Float stru_Int_Float_Int_Float;
typedef struct stru_Int_Double_Float stru_Int_Double_Float;
typedef struct stru_Float_Double_Int stru_Float_Double_Int;
typedef struct stru_Int_Double_Int stru_Int_Double_Int;
typedef struct stru_Float_Double_Float stru_Float_Double_Float;
...
struct stru_Bool_NestedBoolArray {
	bool elem1;
	bool elem2[2];
};
...
struct stru_Bool_NestedStruArray {
	bool elem1;
...
struct stru_Byte_NestedByteArray {
	char elem1;
	char elem2[2];
};
...
struct stru_Byte_NestedStruArray {
	char elem1;
...
struct stru_Char_NestedCharArray {
	short elem1;
	short elem2[2];
};
...
struct stru_Char_NestedStruArray {
	short elem1;
...
struct stru_Short_NestedShortArray {
	short elem1;
	short elem2[2];
};
...
struct stru_Short_NestedStruArray {
	short elem1;
...
struct stru_Int_NestedIntArray {
	int elem1;
	int elem2[2];
};
...
struct stru_Int_NestedStruArray {
	int elem1;
...
struct stru_Long_NestedLongArray {
	LONG elem1;
	LONG elem2[2];
};
...
struct stru_Long_NestedStruArray {
	LONG elem1;
...
struct stru_Float_NestedFloatArray {
	float elem1;
	float elem2[2];
};
...
struct stru_Float_NestedStruArray {
	float elem1;
...
struct stru_Double_NestedDoubleArray {
	double elem1;
	double elem2[2];
};
...
struct stru_Double_NestedStruArray {
	double elem1;
...
struct stru_Int_Double {
	int elem1;
	double elem2;
};

struct stru_Double_Int {
	double elem1;
	int elem2;
};
...
struct stru_Float_Float_Double {
	float elem1;
	float elem2;
	double elem3;
};

struct stru_Double_Float_Float {
	double elem1;
	float elem2;
	float elem3;
};

struct stru_Int_Float_Float {
	int elem1;
	float elem2;
	float elem3;
};

struct stru_Float_Int_Float {
	float elem1;
	int elem2;
	float elem3;
};

struct stru_Int_Float_Double {
	int elem1;
	float elem2;
	double elem3;
};

struct stru_Float_Int_Double {
	float elem1;
	int elem2;
	double elem3;
};

struct stru_Long_Double {
	LONG elem1;
	double elem2;
};

struct stru_Int_3_Floats {
	int elem1;
	float elem2;
	float elem3;
	float elem4;
...
struct stru_Long_2_Floats {
	long elem1;
	float elem2;
	float elem3;
};

struct stru_3_Floats_Int {
	float elem1;
	float elem2;
	float elem3;
	int elem4;
...
struct stru_Float_Long {
	float elem1;
	LONG elem2;
};

struct stru_Double_Float_Int {
	double elem1;
	float elem2;
	int elem3;
};

struct stru_Double_Long {
	double elem1;
	LONG elem2;
};

struct stru_Float_Float_Long {
	float elem1;
	float elem2;
	LONG elem3;
};

struct stru_3_Shorts_Char {
	short elem1[3];
	short elem2; // intended for the char type in java
};

struct stru_Int_Float_Int_Float {
	int elem1;
	float elem2;
	int elem3;
	float elem4;
...
struct stru_Int_Double_Float {
	int elem1;
	double elem2;
	float elem3;
};

struct stru_Float_Double_Int {
	float elem1;
	double elem2;
	int elem3;
};

struct stru_Int_Double_Int {
	int elem1;
	double elem2;
	int elem3;
};

struct stru_Float_Double_Float {
	float elem1;
	double elem2;
	float elem3;
};
