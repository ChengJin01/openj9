...
#if defined(WIN64) || defined(AIXPPC)
/*  The C_LONG_LONG layout maps to long long (8bytes) on Windows/AIX 64-bit */
typedef long long LONG;
#else /* defined(WIN64) || defined(AIXPPC) */
typedef long LONG;
#endif /* defined(WIN64) || defined(AIXPPC) */
