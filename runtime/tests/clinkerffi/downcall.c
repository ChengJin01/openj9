 ...
 */
int
addBoolAndBoolsFromStructWithNestedBoolArray_reverseOrder(int arg1, stru_Bool_NestedBoolArray arg2)
{
	int boolSum = arg1 ^ arg2.elem1 ^ arg2.elem2[0] ^ arg2.elem2[1];
	return boolSum;
}
 ...
 */
int
addBoolAndBoolsFromStructWithNestedStructArray_reverseOrder(int arg1, stru_Bool_NestedStruArray arg2)
{
	int boolSum = arg1 ^ arg2.elem1
...
/**
 * Add a char and all char elements of a struct with a nested char array and a char.
 *
 * @param arg1 a char
...
/**
 * Add a char and all char elements of a struct with a char
 * and a nested char array (in reverse order).
 *
 * @param arg1 a char
...
{
	short charSum = arg1 + arg2.elem2[0] + arg2.elem2[1] + arg2.elem1 - 3 * 'A';
	return charSum;
}

/**
 * Add a char and all char elements of a struct with a nested struct array and a char.
 *
 * @param arg1 a char
 * @param arg2 a struct with a nested char array and a char
...
/**
 * Add a long and all long elements of a struct with a long and a nested struct array.
 *
 * @param arg1 a long
 * @param arg2 a struct with a long and a nested long array
 * @return the sum of long and all elements of the struct
...
/**
 * Create a new struct by adding each float element of two structs (each has two float elements).
 *
...
/**
 * Create a new struct by adding each float element of two structs (each has three float elements).
 *
...
/**
 * Get a pointer to struct by adding each float element of two structs (each has two float elements).
 *
...
addDoubleAndFloatDoubleFromStruct(double arg1, stru_Float_Double arg2)
{
	...
	printf("\naddDoubleAndFloatDoubleFromStruct: arg1 = %f", arg1);
	printf("\naddDoubleAndFloatDoubleFromStruct: arg2.elem1 = %f", arg2.elem1);
	printf("\naddDoubleAndFloatDoubleFromStruct: arg2.elem2 = %f", arg2.elem2);
	printf("\naddDoubleAndFloatDoubleFromStruct: doubleSum = %f", doubleSum);
...
/**
 * Create a new struct by adding each double element of two structs (each has two double elements).
 *
...
/**
 * Get a pointer to struct by adding each double element of two structs (each has two double elements).
 *
...
/**
 * Create a new struct by adding each double element of two structs (each has three double elements).
 *
