 ...
 */
bool
addBoolAndBoolsFromUnionPointerWithXor(bool arg1, union_2_Bools *arg2)
{
	bool boolSum = arg1 ^ arg2->elem1 ^ arg2->elem2;
	return boolSum;
}
 ...
 */
union_2_Bools *
add2BoolUnionsWithXor_returnUnionPointer(union_2_Bools *arg1, union_2_Bools arg2)
{
	arg1->elem1 = arg1->elem1 ^ arg2.elem1;
	arg1->elem2 = arg1->elem2 ^ arg2.elem2;
	return arg1;
 ...
 */
char
addByteAndBytesFromUnionPointer(char arg1, union_2_Bytes *arg2)
{
	char byteSum = arg1 + arg2->elem1 + arg2->elem2;
	return byteSum;
}
 ...
 */
union_2_Bytes *
add2ByteUnions_returnUnionPointer(union_2_Bytes *arg1, union_2_Bytes arg2)
{
	arg1->elem1 = arg1->elem1 + arg2.elem1;
	arg1->elem2 = arg1->elem2 + arg2.elem2;
	return arg1;
 ...
 */
short
addCharAndCharsFromUnionPointer(short arg1, union_2_Chars *arg2)
{
	short result = arg1 + arg2->elem1 + arg2->elem2 - 2 * 'A';
	return result;
}
 ...
 */
union_2_Chars *
add2CharUnions_returnUnionPointer(union_2_Chars *arg1, union_2_Chars arg2)
{
	arg1->elem1 = arg1->elem1 + arg2.elem1 - 'A';
	arg1->elem2 = arg1->elem2 + arg2.elem2 - 'A';
	return arg1;
 ...
 */
short
addShortAndShortsFromUnionPointer(short arg1, union_2_Shorts *arg2)
{
	short shortSum = arg1 + arg2->elem1 + arg2->elem2;
	return shortSum;
}
 ...
 */
union_2_Shorts *
add2ShortUnions_returnUnionPointer(union_2_Shorts *arg1, union_2_Shorts arg2)
{
	arg1->elem1 = arg1->elem1 + arg2.elem1;
	arg1->elem2 = arg1->elem2 + arg2.elem2;
	return arg1;
 ...
 */
int
addIntAndIntsFromUnionPointer(int arg1, union_2_Ints *arg2)
{
	int intSum = arg1 + arg2->elem1 + arg2->elem2;
	return intSum;
}
 ...
 */
union_2_Ints *
add2IntUnions_returnUnionPointer(union_2_Ints *arg1, union_2_Ints arg2)
{
	arg1->elem1 = arg1->elem1 + arg2.elem1;
	arg1->elem2 = arg1->elem2 + arg2.elem2;
	return arg1;
 ...
 */
LONG
addLongAndLongsFromUnionPointer(LONG arg1, union_2_Longs *arg2)
{
	LONG longSum = arg1 + arg2->elem1 + arg2->elem2;
	return longSum;
}
 ...
 */
union_2_Longs *
add2LongUnions_returnUnionPointer(union_2_Longs *arg1, union_2_Longs arg2)
{
	arg1->elem1 = arg1->elem1 + arg2.elem1;
	arg1->elem2 = arg1->elem2 + arg2.elem2;
	return arg1;
 ...
 */
float
addFloatAndFloatsFromUnionPointer(float arg1, union_2_Floats *arg2)
{
	float floatSum = arg1 + arg2->elem1 + arg2->elem2;
	return floatSum;
}
 ...
 */
union_2_Floats *
add2FloatUnions_returnUnionPointer(union_2_Floats *arg1, union_2_Floats arg2)
{
	arg1->elem1 = arg1->elem1 + arg2.elem1;
	arg1->elem2 = arg1->elem2 + arg2.elem2;
	return arg1;
 ...
 */
double
addDoubleAndDoublesFromUnionPointer(double arg1, union_2_Doubles *arg2)
{
	double doubleSum = arg1 + arg2->elem1 + arg2->elem2;
	return doubleSum;
}
 ...
 */
union_2_Doubles *
add2DoubleUnions_returnUnionPointer(union_2_Doubles *arg1, union_2_Doubles arg2)
{
	arg1->elem1 = arg1->elem1 + arg2.elem1;
	arg1->elem2 = arg1->elem2 + arg2.elem2;
	return arg1;
...
/**
 * Add a byte and all elements (byte & short) of a union.
 *
 * @param arg1 a byte
 * @param arg2 a union with a byte and a short
 * @return the sum of bytes and short
 */
short
addShortAndByteShortFromUnion(short arg1, union_Byte_Short arg2)
{
	short shortSum = arg1 + arg2.elem1 + arg2.elem2;
	return shortSum;
}
...
/**
 * Add a byte and all elements (short & byte) of a union.
 *
 * @param arg1 a byte
 ...
 */
short
addShortAndShortByteFromUnion(short arg1, union_Short_Byte arg2)
{
	short shortSum = arg1 + arg2.elem1 + arg2.elem2;
	return shortSum;
}
...
/**
 * Add an integer and all elements (integer & byte) of a union.
 *
 * @param arg1 an integer
 * @param arg2 a union with an integer and a byte
 * @return the sum of integers and byte
 */
int
addIntAndIntByteFromUnion(int arg1, union_Int_Byte arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2;
	return intSum;
}
...
/**
 * Add an integer and all elements (byte & integer) of a union.
 *
 * @param arg1 an integer
 * @param arg2 a union with a byte and an integer
 * @return the sum of integers and byte
 */
int
addIntAndByteIntFromUnion(int arg1, union_Byte_Int arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2;
	return intSum;
}
...
/**
 * Add an integer and all elements (integer & short) of a union.
 *
 * @param arg1 an integer
 * @param arg2 a union with an integer and a short
 * @return the sum of integers and short
 */
int
addIntAndIntShortFromUnion(int arg1, union_Int_Short arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2;
	return intSum;
}
...
/**
 * Add an integer and all elements (short & integer) of a union.
 *
 * @param arg1 an integer
 * @param arg2 a union with a short and an integer
 * @return the sum of integers and short
 */
int
addIntAndShortIntFromUnion(int arg1, union_Short_Int arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2;
	return intSum;
}
...
/**
 * Add an int and all elements (int ,short and byte) of a union.
 *
 * @param arg1 an int
 ...
 */
int
addIntAndIntShortByteFromUnion(int arg1, union_Int_Short_Byte arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return intSum;
}

/**
 * Add an int and all elements (byte, short and int) of a union.
 *
 * @param arg1 an int
 ...
 */
int
addIntAndByteShortIntFromUnion(int arg1, union_Byte_Short_Int arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return intSum;
}
...
/**
 * Add an integer and all elements (int & long) of a union.
 *
 * @param arg1 an int
 * @param arg2 a union with an integer and a long
 * @return the sum of integers and long
 */
LONG
addIntAndIntLongFromUnion(int arg1, union_Int_Long arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2;
	return longSum;
}
...
/**
 * Add a float and all elements (short & float) of a union.
 *
 * @param arg1 a float
 * @param arg2 a union with an short and a float
 * @return the sum of floats and short
 */
float
addFloatAndShortFloatFromUnion(float arg1, union_Short_Float arg2)
{
	float floatSum = arg1 + arg2.elem1 + arg2.elem2;
	return floatSum;
}
...
/**
 * Add a float and all elements (float & short) of a union.
 *
 * @param arg1 a float
 * @param arg2 a union with a float and an short
 * @return the sum of floats and short
 */
float
addFloatAndFloatShortFromUnion(float arg1, union_Float_Short arg2)
{
	float floatSum = arg1 + arg2.elem1 + arg2.elem2;
	return floatSum;
}
...
/**
 * Add an integer and all elements (long & int) of a union.
 *
 * @param arg1 an int
 ...
 */
LONG
addIntAndLongIntFromUnion(int arg1, union_Long_Int arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2;
	return longSum;
}
...
/**
 * Add a float and all elements (int & float) of a union.
 *
 * @param arg1 a float
 ...
 */
float
addFloatAndIntFloatFromUnion(float arg1, union_Int_Float arg2)
{
	float floatSum = arg1 + arg2.elem1 + arg2.elem2;
	return floatSum;
}
...
/**
 * Add a float and all elements (float & int) of a union.
 *
 * @param arg1 a float
 ...
 */
float
addFloatAndFloatIntFromUnion(float arg1, union_Float_Int arg2)
{
	float floatSum = arg1 + arg2.elem1 + arg2.elem2;
	return floatSum;
}
...
/**
 * Add a double and all elements (float & double) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndFloatDoubleFromUnion(double arg1, union_Float_Double arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2;
	return doubleSum;
}
...
/**
 * Add a double and all elements (double & float) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndDoubleFloatFromUnion(double arg1, union_Double_Float arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2;
	return doubleSum;
}
...
/**
 * Add a double and all elements (int & double) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndIntDoubleFromUnion(double arg1, union_Int_Double arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2;
	return doubleSum;
}
...
/**
 * Add a double and all elements (double & int) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndDoubleIntFromUnion(double arg1, union_Double_Int arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2;
	return doubleSum;
}
...
/**
 * Add a long and all elements (float & long) of a union.
 *
 * @param arg1 a long
 ...
 */
LONG
addLongAndFloatLongFromUnion(LONG arg1, union_Float_Long arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2;
	return longSum;
}
...
/**
 * Add a long and all elements (long & float) of a union.
 *
 * @param arg1 a long
 ...
 */
LONG
addLongAndLongFloatFromUnion(LONG arg1, union_Long_Float arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2;
	return longSum;
}
...
/**
 * Add a double and all elements (long & double) of a union.
 *
 * @param arg1 a double
 * @param arg2 a union with a long and a double
 * @return the sum of doubles and long
 */
double
addDoubleAndLongDoubleFromUnion(double arg1, union_Long_Double arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2;
	return doubleSum;
}
...
/**
 * Add a double and all elements (double & long) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndDoubleLongFromUnion(double arg1, union_Double_Long arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2;
	return doubleSum;
}
...
/**
 * Add a double and all elements (int, float and double) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndIntFloatDoubleFromUnion(double arg1, union_Int_Float_Double arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return doubleSum;
}

/**
 * Add a double and all elements (int, double and float) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndIntDoubleFloatFromUnion(double arg1, union_Int_Double_Float arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return doubleSum;
}
...
/**
 * Add a long and all elements (int, float and long) of a union.
 *
 * @param arg1 a long
 ...
 */
LONG
addLongAndIntFloatLongFromUnion(LONG arg1, union_Int_Float_Long arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return longSum;
}

/**
 * Add a long and all elements (int, long and float) of a union.
 *
 * @param arg1 a long
 ...
 */
LONG
addLongAndIntLongFloatFromUnion(LONG arg1, union_Int_Long_Float arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return longSum;
}
...
/**
 * Add a double and all elements (float, long and double) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndFloatLongDoubleFromUnion(double arg1, union_Float_Long_Double arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return doubleSum;
}
...
/**
 * Add a double and all elements (int, double and long) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndIntDoubleLongFromUnion(double arg1, union_Int_Double_Long arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3;
	return doubleSum;
}
...
/**
 * Add a long and all elements (byte, short, int and long) of a union.
 *
 * @param arg1 an int
 ...
 */
LONG
addLongAndByteShortIntLongFromUnion(LONG arg1, union_Byte_Short_Int_Long arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3 + arg2.elem4;
	return longSum;
}

/**
 * Add a long and all elements (long, int, short and byte) of a union.
 *
 * @param arg1 an int
 ...
 */
LONG
addLongAndLongIntShortByteFromUnion(LONG arg1, union_Long_Int_Short_Byte arg2)
{
	LONG longSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3 + arg2.elem4;
	return longSum;
}
...
/**
 * Add a double and all elements (byte, short, float and double) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndByteShortFloatDoubleFromUnion(double arg1, union_Byte_Short_Float_Double arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3 + arg2.elem4;
	return doubleSum;
}

/**
 * Add a double and all elements (double, float, short and byte) of a union.
 *
 * @param arg1 a double
 ...
 */
double
addDoubleAndDoubleFloatShortByteFromUnion(double arg1, union_Double_Float_Short_Byte arg2)
{
	double doubleSum = arg1 + arg2.elem1 + arg2.elem2 + arg2.elem3 + arg2.elem4;
	return doubleSum;
}
...
add2CharStructs_returnStruct_Nested2ByteUnion(stru_Char_NestedUnion_2_Chars arg1, stru_Char_NestedUnion_2_Chars arg2)
{
 ...
 */
short
addShortAndShortsFromUnion_Nested2ByteStruct(short arg1, union_Short_NestedStruct_2_Bytes arg2)
{
	short shortSum = arg1 + arg2.elem1 + arg2.elem2.elem1 + arg2.elem2.elem2;
	return shortSum;
}
...
/**
 * Add a short and all elements of a union with a short and a nested bytes (4 bytes).
 *
 * @param arg1 a short
 * @param arg2 a union with a short and a nested bytes (4 bytes)
 * @return the sum
 */
short
addShortAndShortsFromUnion_Nested4ByteStruct(short arg1, union_Short_NestedStruct_4_Bytes arg2)
{
	short shortSum = arg1 + arg2.elem1 + arg2.elem2.elem1
			+ arg2.elem2.elem2 + arg2.elem2.elem3 + arg2.elem2.elem4;
	return shortSum;
 ...
 */
int
addIntAndIntsFromUnion_Nested2ShortStruct(int arg1, union_Int_NestedStruct_2_Shorts arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2.elem1 + arg2.elem2.elem2;
	return intSum;
}
...
/**
 * Add an int and all elements of a union with an int and a nested structs (4 shorts).
 *
 * @param arg1 an int
 ...
 */
int
addIntAndIntsFromUnion_Nested4ShortStruct(int arg1, union_Int_NestedStruct_4_Shorts arg2)
{
	int intSum = arg1 + arg2.elem1 + arg2.elem2.elem1
			+ arg2.elem2.elem2 + arg2.elem2.elem3 + + arg2.elem2.elem4;
	return intSum;
