 ...
 */
int add2Ints(int intArg1, int intArg2) {
 ...
 */
int addIntAndIntFromPointer(int intArg1, int *intArg2) {
	int intSum = intArg1 + *intArg2;
	return intSum;
}
 ...
 */
int add3Ints(int intArg1, int intArg2, int intArg3) {
 ...
 */
int addIntsFromVaList(int intCount, va_list intVaList) {
	int intSum = 0;
	while (intCount > 0) {
 ...
 */
int addIntAndChar(int intArg, char charArg) {
 ...
 * @return void
 */
void add2IntsReturnVoid(int intArg1, int intArg2) {
	int intSum = intArg1 + intArg2;
}
 ...
 */
int add2BoolsWithOr(int boolArg1, int boolArg2) {
 ...
 * @return the result of the OR operation
 */
int addBoolAndBoolFromPointerWithOr(int boolArg1, int *boolArg2) {
	int result = (boolArg1 || *boolArg2);
	return result;
}
 ...
 */
short createNewCharFrom2Chars(short charArg1, short charArg2) {
 ...
 * @return the resulting character generated with the 2 characters
 */
short createNewCharFromCharAndCharFromPointer(short *charArg1, short charArg2) {
	int diff = (charArg2 >= *charArg1) ? (charArg2 - *charArg1) : (*charArg1 - charArg2);
	diff = (diff > 5) ? 5 : diff;
	short result = diff + 'A';
	return result;
 ...
 */
char add2Bytes(char byteArg1, char byteArg2) {
 ...
 * @return the sum of the two bytes
 */
char addByteAndByteFromPointer(char byteArg1, char *byteArg2) {
	char byteSum = byteArg1 + *byteArg2;
	return byteSum;
}
 ...
 */
short add2Shorts(short shortArg1, short shortArg2) {
 ...
 * @return the sum of the two short integers
 */
short addShortAndShortFromPointer(short *shortArg1, short shortArg2) {
	short shortSum = *shortArg1 + shortArg2;
	return shortSum;
}
 ...
 */
long add2Longs(long longArg1, long longArg2) {
 ...
 * @return the sum of the two long integers
 */
long addLongAndLongFromPointer(long *longArg1, long longArg2) {
	long longSum = *longArg1 + longArg2;
	return longSum;
}
 ...
 */
long addLongsFromVaList(int longCount, va_list longVaList) {
	long longSum = 0;
	while (longCount > 0) {
 ...
 */
float add2Floats(float floatArg1, float floatArg2) {
 ...
 * @return the sum of the two floats
 */
float addFloatAndFloatFromPointer(float floatArg1, float *floatArg2) {
	float floatSum = floatArg1 + *floatArg2;
	return floatSum;
}
 ...
 */
double add2Doubles(double doubleArg1, double doubleArg2) {
 ...
 * @return the sum of the two doubles
 */
double addDoubleAndDoubleFromPointer(double *doubleArg1, double doubleArg2) {
	double doubleSum = *doubleArg1 + doubleArg2;
	return doubleSum;
}
 ...
 */
double addDoublesFromVaList(int doubleCount, va_list doubleVaList) {
	double doubleSum = 0;
	while (doubleCount > 0) {
