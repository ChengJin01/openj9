...
/**
 * Add a boolean and all booleans of a struct with a nested struct with the XOR (^) operator.
 *
 * @param arg1 a boolean
...
/**
 * Generate a new char by adding a char and all char elements of a struct with a nested struct.
 *
 * @param arg1 a char
 * @param arg2 a struct with a nested struct.
 * @return a char
...
/**
 * Add a float and all float elements of a struct with a nested struct.
 *
 * @param arg1 a float
 * @param arg2 a struct with a nested struct
 * @return the sum of floats
