...
<#elseif uma.spec.processor.amd64>
ASFLAGS+=-DWIN64 -D_WIN64 -DX86_WIN64 -DJ9HAMMER
</#if>
...
<#if uma.spec.processor.amd64>
  CFLAGS+=-D_AMD64_=1 -DWIN64 -D_WIN64 -DX86_WIN64 -DJ9HAMMER
  CXXFLAGS+=-D_AMD64_=1 -DWIN64 -D_WIN64 -DX86_WIN64 -DJ9HAMMER
  ifdef USE_CLANG
    CLANG_CXXFLAGS+=-D_AMD64_=1 -DWIN64 -D_WIN64 -DX86_WIN64 -DJ9HAMMER
  endif
