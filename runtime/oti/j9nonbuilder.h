...
typedef struct J9MemoryManagerFunctions {
	...
	void ( *j9gc_objaccess_copyObjectFields)(struct J9VMThread *vmThread, J9Class* valueClass, j9object_t srcObject, UDATA srcOffset, j9object_t destObject, UDATA destOffset, MM_objectMapFunction objectMapFunction, void *objectMapData) ;
...
typedef struct J9UpcallMetaData {
	...
	UDATA *spForCalleeMH; /* The pointer to the slot of target method handle reserved on the stack */
} J9UpcallMetaData;
