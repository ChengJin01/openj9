...
#define J9_FFI_UPCALL_SIG_TYPE_VOID 1
#define J9_FFI_UPCALL_SIG_TYPE_CHAR 2
#define J9_FFI_UPCALL_SIG_TYPE_SHORT 3
#define J9_FFI_UPCALL_SIG_TYPE_INT32 4
#define J9_FFI_UPCALL_SIG_TYPE_INT64 5
#define J9_FFI_UPCALL_SIG_TYPE_FLOAT 6
#define J9_FFI_UPCALL_SIG_TYPE_DOUBLE 7
#define J9_FFI_UPCALL_SIG_TYPE_POINTER 8
#define J9_FFI_UPCALL_SIG_TYPE_VA_LIST 9  //unused as it is converted to C_POINTER in OpenJDK

#define J9_FFI_UPCALL_SIG_TYPE_STRUCT 10 // The generic struct type used in the upcall targets
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_ALL_SP 10 // Intended for structs with all floats
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_ALL_DP 11 // Intended for structs with all doubles

/* Intended for structs bigger than 16-byte but neither ALL_SP nor ALL_DP */
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_OTHER 12

/* The following AGGREGATE subtypes are intended for structs which are equal to or less than 16-byte in size */
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_SP_DP 13 // Intended for {float, padding, double}
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_SP_SP_DP 14 // Intended for {float, float, double}
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_DP_SP 15 // Intended for {double, float, padding}
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_DP_SP_SP 16 // Intended for {double, float, float}

/* Intended for structs with the 1st MISC 8-byte and the 2nd float 8-byte. e.g. {int, float, float} or {float, int, float} */
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_MISC_SP 17
/* Intended for structs with the 1st MISC 8-byte and the 2nd double 8-byte. e.g. {int, float, double} or {float, int, double} */
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_MISC_DP 18
/* Intended for structs with the 1st float 8-byte and the 2nd MISC 8-byte. e.g. {float, float, float, int} */
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_SP_MISC 19
/* Intended for structs with the 1st double 8-byte and the 2nd MISC 8-byte. e.g. {double, float, int} */
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_DP_MISC 20
/* Intended for structs without pure float/double in 8 bytes. e.g. {short a[3], char b} */
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_MISC 21
...
typedef struct J9UpcallMetaData {
	J9JavaVM *vm;
	jobject mhMetaData; /* includes a global JNI reference to the upcall MH plus the metaData for MH resolution */
	...
	void *codeAddress; /* the address of upcall targets to be filled by codeGen */
	UDATA codeAddressPtr[3]; /* the address of upcall targets on AIX or z/OS */
...
typedef struct J9UpcallMetaDataList {
	J9UpcallMetaData *data;
	J9UpcallMetaDataList *next;
...
typedef struct J9UpcallThunkHeapWrapper {
	...
	J9UpcallMetaDataList *metaDataHead;
...
#if JAVA_SPEC_VERSION >= 16
	long ( *createUpcallThunk)(J9UpcallMetaData *data);
	void * ( *allocateUpcallThunkMemory)(J9JavaVM *vm, J9UpcallMetaData *data, UDATA thunkSize);
	void ( *doneUpcallThunkGeneration)(J9JavaVM *vm, void *thunkAddress, UDATA thunkSize);
	void ( *icallVMprJavaUpcall0)(J9UpcallMetaData *data, void *argsListPointer);
	I_32 ( *icallVMprJavaUpcall1)(J9UpcallMetaData *data, void *argsListPointer);
	I_64 ( *icallVMprJavaUpcallJ)(J9UpcallMetaData *data, void *argsListPointer);
	float ( *icallVMprJavaUpcallF)(J9UpcallMetaData *data, void *argsListPointer);
	double ( *icallVMprJavaUpcallD)(J9UpcallMetaData *data, void *argsListPointer);
	U_8 * ( *icallVMprJavaUpcallStruct)(J9UpcallMetaData *data, void *argsListPointer);
#endif /* JAVA_SPEC_VERSION >= 16 */
