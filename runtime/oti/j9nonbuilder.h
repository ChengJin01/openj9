...
typedef struct J9InternalVMFunctions {
	...
	void ( *icallVMprJavaUpcall0)(struct J9UpcallMetaData *data, void *argsListPointer);
	I_32 ( *icallVMprJavaUpcall1)(struct J9UpcallMetaData *data, void *argsListPointer);
	I_64 ( *icallVMprJavaUpcallJ)(struct J9UpcallMetaData *data, void *argsListPointer);
	float ( *icallVMprJavaUpcallF)(struct J9UpcallMetaData *data, void *argsListPointer);
	double ( *icallVMprJavaUpcallD)(struct J9UpcallMetaData *data, void *argsListPointer);
	U_8 * ( *icallVMprJavaUpcallStruct)(struct J9UpcallMetaData *data, void *argsListPointer);
#endif /* JAVA_SPEC_VERSION >= 16 */
...
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_MIN 10 // The generic struct type used in the upcall targets
...
#define J9_FFI_UPCALL_SIG_TYPE_STRUCT_AGGREGATE_MAX 21
