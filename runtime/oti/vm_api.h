...
/**
 * @brief Parse the native signature in the data and creates a thunk that marshals in the arguments
 * and calls into one of the icallVMprJavaUpcallfunctions to return the thunk address.
 *
 * @param data the pointer to J9UpcallMetaData
 * @return the address to the thunk generated by JIT
 */
long
 ...
 * @param thunkSize The size of the upcall thunk to be generated
 * @return The start address of the upcall thunk memory
 */
void *
allocateUpcallThunkMemory(J9JavaVM *vm, UDATA thunkSize);
