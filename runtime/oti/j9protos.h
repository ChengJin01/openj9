...
extern J9_CFUNC void resolveUpcallInvokeHandle(J9VMThread *vmThread, j9object_t mhMetaData);
...
#if JAVA_SPEC_VERSION >= 16
extern J9_CFUNC void JNICALL sendResolveUpcallInvokeHandle (J9VMThread *currentThread, j9object_t mhMetaData);
#endif /* JAVA_SPEC_VERSION >= 16 */
