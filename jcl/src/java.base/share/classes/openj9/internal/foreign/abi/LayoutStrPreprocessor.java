...
final class LayoutStrPreprocessor {
	...
	private static StringBuilder composeStructLayoutStr(StringBuilder targetLayoutStr, int elemCount, int elemLayoutStrsLength) {
		/* Count '#', '&', '[' and ']' (4 chars) plus the length digits of the element count
		 * and the length digits of the element layout string in computing the length of the
		 * struct layout string which is intended to hash the layout string in native.
		 */
