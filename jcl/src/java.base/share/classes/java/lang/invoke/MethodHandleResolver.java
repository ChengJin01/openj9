...
/*[IF OPENJDK_METHODHANDLES]*/
		...
		//System.out.println("linkCallerMethod: callerClass = " + callerClass); //$NON-NLS-1$
		//System.out.println("linkCallerMethod: definingClass = " + definingClass); //$NON-NLS-1$
		//System.out.println("linkCallerMethod: name = " + name); //$NON-NLS-1$
		//System.out.println("linkCallerMethod: type = " + type); //$NON-NLS-1$
		//System.out.println("linkCallerMethod: mt = " + mt); //$NON-NLS-1$
		...
		//System.out.println("linkCallerMethod: result[0] = " + result[0]); //$NON-NLS-1$
		//System.out.println("linkCallerMethod: result[1] = " + result[1]); //$NON-NLS-1$
