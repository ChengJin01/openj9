...
class UpcallMHMetaData {
	...
	/* The target method handle intended for upcall */
	private MethodHandle calleeMH;
	/* The method type of the target method handle */
	private MethodType calleeType;
	/* MemberName and appendix (resolved by MethodHandleResolver.upcallLinkCallerMethod()) are stored in this array */
