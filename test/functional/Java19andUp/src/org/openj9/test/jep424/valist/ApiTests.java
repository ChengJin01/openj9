...
public class ApiTests {
	...
	public void test_emptyVaList() throws Throwable {
		try (MemorySession session = MemorySession.openConfined()) {
			 ...
			 * the empty va_list on Windows/x86_64, MacOS/Aarch64, Linux/ppc64le while
			 * the va_list without any argument is created on a fixed address on other
			 * platforms.
			 */
			if (isWinOS || isMacOsAarch64 || isSysVPPC64le) {
