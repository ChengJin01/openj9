...
public class StructTests1 {
	...
	@Test
	public void test_addLongAndLong2FloatsFromStruct_1() throws Throwable {
		GroupLayout structLayout = MemoryLayout.structLayout(JAVA_LONG.withName("elem1"),
		...
		FunctionDescriptor fd = FunctionDescriptor.ofVoid(JAVA_LONG, structLayout);
		Addressable functionSymbol = nativeLibLookup.lookup("addLongAndLong2FloatsFromStruct").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (MemorySession session = MemorySession.openConfined()) {
			...
			mh.invoke(555555555555L, structSegmt);
		}
	}
}
