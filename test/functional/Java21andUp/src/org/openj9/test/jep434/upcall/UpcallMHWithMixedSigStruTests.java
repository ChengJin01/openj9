...
/**
 * Test cases for JEP 442: Foreign Linker API (Third Preview) for the mixed native signatures
...
public class UpcallMHWithMixedSigStruTests {
	...
	public void test_return254BytesFromStructByUpcallMH() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment byteArrStruSegment = (MemorySegment)mh.invoke(arena, upcallFuncAddr);
			for (int i = 0; i < 254; i++) {
