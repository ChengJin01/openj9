...
/**
 * Test cases for JEP 442: Foreign Linker API (Third Preview) for primitive types in upcall.
 */
...
public class UpcallMHWithPrimTests {
	...
	public void test_addByteAndByteFromPointerByUpcallMH() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment byteSegmt = arena.allocate(JAVA_BYTE, (byte)7);
	...
	public void test_addByteAndByteFromPtr_RetPtr_ByUpcallMH() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment byteSegmt = arena.allocate(JAVA_BYTE, (byte)35);
	...
	public void test_addShortAndShortFromPointerByUpcallMH() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment shortSegmt = arena.allocate(JAVA_SHORT, (short)2222);
	...
	public void test_addIntAndIntFromPointerByUpcallMH() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment intSegmt = arena.allocate(JAVA_INT, 222215);
	...
	public void test_qsortByUpcallMH() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment arraySegmt =  arena.allocateArray(JAVA_INT, new int[]{17, 14, 13, 16, 15, 12, 11});
