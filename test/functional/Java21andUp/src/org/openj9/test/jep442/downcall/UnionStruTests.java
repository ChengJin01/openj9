...
public class UnionStruTests {
	...
	@Test
	public void test_add2CharStructs_returnStruct_Nested2ByteUnion() throws Throwable {
		GroupLayout nestedUnionLayout = MemoryLayout.unionLayout(JAVA_CHAR.withName("elem1"), JAVA_CHAR.withName("elem2"));
		GroupLayout structLayout = MemoryLayout.structLayout(JAVA_CHAR.withName("elem1"), nestedUnionLayout.withName("union_elem2"));
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2CharStructs_returnStruct_Nested2ByteUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addShortAndShortsFromUnion_Nested2ByteStruct() throws Throwable {
		GroupLayout nestedStructLayout = MemoryLayout.structLayout(JAVA_BYTE.withName("elem1"), JAVA_BYTE.withName("elem2"));
		GroupLayout unionLayout = MemoryLayout.unionLayout(JAVA_SHORT.withName("elem1"), nestedStructLayout.withName("struct_elem2"));
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_SHORT, JAVA_SHORT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addShortAndShortsFromUnion_Nested2ByteStruct").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addShortAndShortsFromUnion_Nested4ByteStruct() throws Throwable {
		GroupLayout nestedStructLayout = MemoryLayout.structLayout(JAVA_BYTE.withName("elem1"), JAVA_BYTE.withName("elem2"),
		JAVA_BYTE.withName("elem3"), JAVA_BYTE.withName("elem4"));
		GroupLayout unionLayout = MemoryLayout.unionLayout(JAVA_SHORT.withName("elem1"), nestedStructLayout.withName("struct_elem2"));
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_SHORT, JAVA_SHORT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addShortAndShortsFromUnion_Nested4ByteStruct").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals(unionSegmt.get(JAVA_SHORT, 0), 5643);

			short result = (short)mh.invokeExact((short)11111, unionSegmt);
			Assert.assertEquals(result, 16864);
		}
	}

	@Test
	public void test_addIntAndIntsFromUnion_Nested2ShortStruct() throws Throwable {
		GroupLayout nestedStructLayout = MemoryLayout.structLayout(JAVA_SHORT.withName("elem1"), JAVA_SHORT.withName("elem2"));
		GroupLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"), nestedStructLayout.withName("struct_elem2"));
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndIntsFromUnion_Nested2ShortStruct").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addIntAndIntsFromUnion_Nested4ShortStruct() throws Throwable {
		GroupLayout nestedStructLayout = MemoryLayout.structLayout(JAVA_SHORT.withName("elem1"), JAVA_SHORT.withName("elem2"),
		JAVA_SHORT.withName("elem3"), JAVA_SHORT.withName("elem4"));
		GroupLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"), nestedStructLayout.withName("struct_elem2"));
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndIntsFromUnion_Nested4ShortStruct").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals(unionSegmt.get(JAVA_INT, 0), 728247143);

			int result = (int)mh.invokeExact(22446688, unionSegmt);
			Assert.assertEquals(result, 750738281);
		}
	}
}
