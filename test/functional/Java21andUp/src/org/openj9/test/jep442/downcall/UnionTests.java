...
public class UnionTests {
	...
	@Test
	public void test_addBoolAndBoolsFromUnionPointerWithXor() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BOOLEAN.withName("elem1"), JAVA_BOOLEAN.withName("elem2"));
		...
		MemorySegment functionSymbol = nativeLibLookup.find("addBoolAndBoolsFromUnionPointerWithXor").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2BoolUnionsWithXor_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BOOLEAN.withName("elem1"), JAVA_BOOLEAN.withName("elem2"));
		VarHandle boolHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle boolHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2BoolUnionsWithXor_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addByteAndBytesFromUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BYTE.withName("elem1"), JAVA_BYTE.withName("elem2"));
		...
		MemorySegment functionSymbol = nativeLibLookup.find("addByteAndBytesFromUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2ByteUnions_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BYTE.withName("elem1"), JAVA_BYTE.withName("elem2"));
		VarHandle byteHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle byteHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2ByteUnions_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addCharAndCharsFromUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_CHAR.withName("elem1"), JAVA_CHAR.withName("elem2"));
		VarHandle charHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle charHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_CHAR, JAVA_CHAR, ADDRESS);
		MemorySegment functionSymbol = nativeLibLookup.find("addCharAndCharsFromUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2CharUnions_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_CHAR.withName("elem1"), JAVA_CHAR.withName("elem2"));
		VarHandle charHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle charHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2CharUnions_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addShortAndShortsFromUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_SHORT.withName("elem1"), JAVA_SHORT.withName("elem2"));
		...
		MemorySegment functionSymbol = nativeLibLookup.find("addShortAndShortsFromUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2ShortUnions_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_SHORT.withName("elem1"), JAVA_SHORT.withName("elem2"));
		VarHandle shortHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle shortHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2ShortUnions_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addIntAndIntsFromUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"), JAVA_INT.withName("elem2"));
		...
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndIntsFromUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2IntUnions_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"), JAVA_INT.withName("elem2"));
		VarHandle intHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle intHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2IntUnions_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addLongAndLongsFromUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_LONG.withName("elem1"), JAVA_LONG.withName("elem2"));
		VarHandle longHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle longHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_LONG, ADDRESS);
		MemorySegment functionSymbol = nativeLibLookup.find("addLongAndLongsFromUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2LongUnions_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_LONG.withName("elem1"), JAVA_LONG.withName("elem2"));
		VarHandle longHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle longHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2LongUnions_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addFloatAndFloatsFromUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_FLOAT.withName("elem1"), JAVA_FLOAT.withName("elem2"));
		VarHandle floatHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle floatHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_FLOAT, JAVA_FLOAT, ADDRESS);
		MemorySegment functionSymbol = nativeLibLookup.find("addFloatAndFloatsFromUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2FloatUnions_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_FLOAT.withName("elem1"), JAVA_FLOAT.withName("elem2"));
		VarHandle floatHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle floatHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2FloatUnions_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addDoubleAndDoublesFromUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_DOUBLE.withName("elem1"), JAVA_DOUBLE.withName("elem2"));
		VarHandle doubleHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle doubleHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, ADDRESS);
		MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndDoublesFromUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_add2DoubleUnions_returnUnionPointer() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_DOUBLE.withName("elem1"), JAVA_DOUBLE.withName("elem2"));
		VarHandle doubleHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle doubleHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(ADDRESS, ADDRESS, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("add2DoubleUnions_returnUnionPointer").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
	...
	@Test
	public void test_addShortAndByteShortFromUnion() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_SHORT, JAVA_SHORT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addShortAndByteShortFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, (byte)254);
			elemHandle2.set(unionSegmt, (short)10001);
			Assert.assertEquals((byte)elemHandle1.get(unionSegmt), 17);

			short result = (short)mh.invokeExact((short)10020, unionSegmt);
			Assert.assertEquals(result, 20038);
		}
	}

	@Test
	public void test_addShortAndShortByteFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_SHORT.withName("elem1"), JAVA_BYTE.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_SHORT, JAVA_SHORT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addShortAndShortByteFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((short)elemHandle1.get(unionSegmt), 10094);

			short result = (short)mh.invokeExact((short)10020, unionSegmt);
			Assert.assertEquals(result, 20224);
		}
	}

	@Test
	public void test_addIntAndIntByteFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"), JAVA_BYTE.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndIntByteFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 11223344);
			elemHandle2.set(unionSegmt, (byte)110);
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 11223406);

			int result = (int)mh.invokeExact(22334455, unionSegmt);
			Assert.assertEquals(result, 33557971);
		}
	}

	@Test
	public void test_addIntAndByteIntFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BYTE.withName("elem1"), JAVA_INT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndByteIntFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, (byte)110);
			elemHandle2.set(unionSegmt, 1122334);
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 30);

			int result = (int)mh.invokeExact(11335577, unionSegmt);
			Assert.assertEquals(result, 12457941);
		}
	}

	@Test
	public void test_addIntAndIntShortFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"), JAVA_SHORT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndIntShortFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 11239422);

			int result = (int)mh.invokeExact(22334455, unionSegmt);
			Assert.assertEquals(result, 33606643);
		}
	}

	@Test
	public void test_addIntAndShortIntFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_SHORT.withName("elem1"), JAVA_INT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndShortIntFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, (short)32766);
			elemHandle2.set(unionSegmt, 1122334);
			Assert.assertEquals((short)elemHandle1.get(unionSegmt), 8222);

			int result = (int)mh.invokeExact(11335577, unionSegmt);
			Assert.assertEquals(result, 12466133);
		}
	}

	@Test
	public void test_addIntAndIntShortByteFromUnion() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndIntShortByteFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 11239190);
			Assert.assertEquals((short)elemHandle2.get(unionSegmt), 32534);

			int result = (int)mh.invokeExact(22334455, unionSegmt);
			Assert.assertEquals(result, 33606201);
		}
	}

	@Test
	public void test_addIntAndByteShortIntFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BYTE.withName("elem1"),
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndByteShortIntFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, (byte)22);
			elemHandle2.set(unionSegmt, (short)32766);
			elemHandle3.set(unionSegmt, 11223344);
			Assert.assertEquals((byte)elemHandle1.get(unionSegmt), 48);
			Assert.assertEquals((short)elemHandle2.get(unionSegmt), 16688);

			int result = (int)mh.invokeExact(11335577, unionSegmt);
			Assert.assertEquals(result, 22575657);
		}
	}

	@Test
	public void test_addIntAndIntLongFromUnion() throws Throwable {
		...
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndIntLongFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 2069059131);

			long result = (long)mh.invokeExact(22446688, unionSegmt);
			Assert.assertEquals(result, 669880495830L);
		}
	}

	@Test
	public void test_addIntAndLongIntFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_LONG.withName("elem1"), JAVA_INT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_INT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addIntAndLongIntFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 667788990011L);
			elemHandle2.set(unionSegmt, 1122334455);
			Assert.assertEquals((long)elemHandle1.get(unionSegmt), 666842265335L);

			long result = (long)mh.invokeExact(1234567, unionSegmt);
			Assert.assertEquals(result, 667965834357L);
		}
	}

	@Test
	public void test_addFloatAndShortFloatFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, (short)11223);
			elemHandle2.set(unionSegmt, 0.11F);
			Assert.assertEquals((short)elemHandle1.get(unionSegmt), 18350);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_FLOAT, JAVA_FLOAT, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addFloatAndShortFloatFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			float result = (float)mh.invokeExact(0.22F, unionSegmt);
			Assert.assertEquals(result, 18350.33F, 0.01F);
		}
	}

	@Test
	public void test_addFloatAndFloatShortFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_FLOAT.withName("elem1"), JAVA_SHORT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_FLOAT, JAVA_FLOAT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addFloatAndFloatShortFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 0.11F);
			elemHandle2.set(unionSegmt, (short)11223);
			Assert.assertEquals((float)elemHandle1.get(unionSegmt), 0.12F, 0.01F);

			float result = (float)mh.invokeExact(0.22F, unionSegmt);
			Assert.assertEquals(result, 11223.33F, 0.01F);
		}
	}

	@Test
	public void test_addFloatAndIntFloatFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle2.set(unionSegmt, 0.11F);
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 1038174126);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_FLOAT, JAVA_FLOAT, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addFloatAndIntFloatFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			float result = (float)mh.invokeExact(0.22F, unionSegmt);
			Assert.assertEquals(result, 1038174144.0F, 0.1F);
		}
	}

	@Test
	public void test_addFloatAndFloatIntFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_FLOAT.withName("elem1"), JAVA_INT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_FLOAT, JAVA_FLOAT, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addFloatAndFloatIntFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle1.set(unionSegmt, 0.11F);
			elemHandle2.set(unionSegmt, 1122334455);
			Assert.assertEquals((float)elemHandle1.get(unionSegmt), 114.7F, 0.1F);

			float result = (float)mh.invokeExact(0.22F, unionSegmt);
			Assert.assertEquals(result, 1122334592.0F, 0.1F);
		}
	}

	@Test
	public void test_addDoubleAndFloatDoubleFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle2.set(unionSegmt, 619.777D);
			Assert.assertEquals((float)elemHandle1.get(unionSegmt), 26038240F);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndFloatDoubleFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			double result = (double)mh.invokeExact(113.567D, unionSegmt);
			Assert.assertEquals(result, 26038973.3D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndDoubleFloatFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_DOUBLE.withName("elem1"), JAVA_FLOAT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndDoubleFloatFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((double)elemHandle1.get(unionSegmt), 218.6D, 0.1D);

			double result = (double)mh.invokeExact(216.666D, unionSegmt);
			Assert.assertEquals(result, 454.4D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndIntDoubleFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle1.set(unionSegmt, 1122334455);
			elemHandle2.set(unionSegmt, 619.777D);
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 1271310320);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndIntDoubleFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			double result = (double)mh.invokeExact(113.567D, unionSegmt);
			Assert.assertEquals(result, 1271311053.3D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndDoubleIntFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_DOUBLE.withName("elem1"), JAVA_INT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndDoubleIntFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			double result = (double)mh.invokeExact(216.666D, unionSegmt);
			Assert.assertEquals(result, 1122334890.2D, 0.1D);
		}
	}

	@Test
	public void test_addLongAndFloatLongFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((float)elemHandle1.get(unionSegmt), 252832.1F, 0.1F);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_LONG, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addLongAndFloatLongFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			long result = (long)mh.invokeExact(1020302010L, unionSegmt);
			Assert.assertEquals(result, 101020549120L);
		}
	}

	@Test
	public void test_addLongAndLongFloatFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_LONG.withName("elem1"), JAVA_FLOAT.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_LONG, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addLongAndLongFloatFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 100000000005L);
			elemHandle2.set(unionSegmt, 333.444F);
			Assert.assertEquals((long)elemHandle1.get(unionSegmt), 99919247573L);

			long result = (long)mh.invokeExact(1020302010L, unionSegmt);
			Assert.assertEquals(result, 100939546624L);
		}
	}

	@Test
	public void test_addDoubleAndLongDoubleFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 11223344556677L);
			elemHandle2.set(unionSegmt, 222.333D);
			Assert.assertEquals((long)elemHandle1.get(unionSegmt), 4642026663563866669L);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndLongDoubleFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			double result = (double)mh.invokeExact(111.222D, unionSegmt);
			Assert.assertEquals(result, 4642026663563867136.0D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndDoubleLongFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_DOUBLE.withName("elem1"), JAVA_LONG.withName("elem2"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndDoubleLongFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 111.222D);
			elemHandle2.set(unionSegmt, 11223344556677L);
			Assert.assertEquals((double)elemHandle1.get(unionSegmt), 0.0D, 0.1D);

			double result = (double)mh.invokeExact(222.333D, unionSegmt);
			Assert.assertEquals(result, 11223344556899.3D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndIntFloatDoubleFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 1234567890);
			elemHandle2.set(unionSegmt, 18.444F);
			elemHandle3.set(unionSegmt, 619.777D);
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 1271310320);
			Assert.assertEquals((float)elemHandle2.get(unionSegmt), 26038240.0F, 0.1F);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndIntFloatDoubleFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			double result = (double)mh.invokeExact(113.567D, unionSegmt);
			Assert.assertEquals(result, 1297349293.3D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndIntDoubleFloatFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"),
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndIntDoubleFloatFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 1100189008);
			Assert.assertEquals((double)elemHandle2.get(unionSegmt), 619.8D, 0.1D);

			double result = (double)mh.invokeExact(113.567D, unionSegmt);
			Assert.assertEquals(result, 1100189759.8D, 0.1D);
		}
	}

	@Test
	public void test_addLongAndIntFloatLongFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"),
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 1215752197);
			Assert.assertEquals((float)elemHandle2.get(unionSegmt), 252832.1F, 0.1F);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_LONG, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addLongAndIntFloatLongFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			long result = (long)mh.invokeExact(1020302010L, unionSegmt);
			Assert.assertEquals(result, 102236307456L);
		}
	}

	@Test
	public void test_addLongAndIntLongFloatFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"),
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_LONG, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addLongAndIntLongFloatFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle3.set(unionSegmt, 18.444F);
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 1100189008);
			Assert.assertEquals((long)elemHandle2.get(unionSegmt), 99884436816L);

			long result = (long)mh.invokeExact(1020302010L, unionSegmt);
			Assert.assertEquals(result, 102004924416L);
		}
	}

	@Test
	public void test_addDoubleAndFloatLongDoubleFromUnion() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle2.set(unionSegmt, 10000000000001L);
			elemHandle3.set(unionSegmt, 100.1111D);
			Assert.assertEquals((float)elemHandle1.get(unionSegmt), 172.6F, 0.1F);
			Assert.assertEquals((long)elemHandle2.get(unionSegmt), 4636745109322114426L);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndFloatLongDoubleFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			double result = (double)mh.invokeExact(222.44D, unionSegmt);
			Assert.assertEquals(result, 4636745109322114048.0D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndIntDoubleLongFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_INT.withName("elem1"),
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndIntDoubleLongFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 12345678);
			elemHandle2.set(unionSegmt, 100.1111D);
			elemHandle3.set(unionSegmt, 1000000001L);
			Assert.assertEquals((int)elemHandle1.get(unionSegmt), 1000000001);
			Assert.assertEquals((double)elemHandle2.get(unionSegmt), 0.0D, 0.1D);

			double result = (double)mh.invokeExact(222.44D, unionSegmt);
			Assert.assertEquals(result, 2000000224.4D, 0.1D);
		}
	}
	...
	@Test
	public void test_addLongAndByteShortIntLongFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BYTE.withName("elem1"),
		JAVA_SHORT.withName("elem2"), JAVA_INT.withName("elem3"), JAVA_LONG.withName("elem4"));
		VarHandle elemHandle1 = unionLayout.varHandle(PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = unionLayout.varHandle(PathElement.groupElement("elem2"));
		VarHandle elemHandle3 = unionLayout.varHandle(PathElement.groupElement("elem3"));
		VarHandle elemHandle4 = unionLayout.varHandle(PathElement.groupElement("elem4"));

		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_LONG, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addLongAndByteShortIntLongFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle2.set(unionSegmt, (short)32766);
			elemHandle3.set(unionSegmt, 11223344);
			elemHandle4.set(unionSegmt, 667788990011L);
			Assert.assertEquals((byte)elemHandle1.get(unionSegmt), 59);
			Assert.assertEquals((short)elemHandle2.get(unionSegmt), 22075);
			Assert.assertEquals((int)elemHandle3.get(unionSegmt), 2069059131);

			long result = (long)mh.invokeExact(1020302010L, unionSegmt);
			Assert.assertEquals(result, 670878373286L);
		}
	}

	@Test
	public void test_addLongAndLongIntShortByteFromUnion() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_LONG, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addLongAndLongIntShortByteFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle3.set(unionSegmt, (short)32766);
			elemHandle4.set(unionSegmt, (byte)22);
			Assert.assertEquals((long)elemHandle1.get(unionSegmt), 665731170070L);
			Assert.assertEquals((int)elemHandle2.get(unionSegmt), 11239190);
			Assert.assertEquals((short)elemHandle3.get(unionSegmt), 32534);

			long result = (long)mh.invokeExact(1020302010L, unionSegmt);
			Assert.assertEquals(result, 666762743826L);
		}
	}

	@Test
	public void test_addDoubleAndByteShortFloatDoubleFromUnion() throws Throwable {
		UnionLayout unionLayout = MemoryLayout.unionLayout(JAVA_BYTE.withName("elem1"),
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			elemHandle1.set(unionSegmt, (byte)22);
			elemHandle2.set(unionSegmt, (short)32766);
			elemHandle3.set(unionSegmt, 1.001F);
			elemHandle4.set(unionSegmt, 200.1D);
			Assert.assertEquals((byte)elemHandle1.get(unionSegmt), 51);
			Assert.assertEquals((short)elemHandle2.get(unionSegmt), 13107);
			Assert.assertEquals((float)elemHandle3.get(unionSegmt), 0.0F, 0.1F);

			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
			MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndByteShortFloatDoubleFromUnion").get();
			MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

			double result = (double)mh.invokeExact(33333.567D, unionSegmt);
			Assert.assertEquals(result, 46691.7D, 0.1D);
		}
	}

	@Test
	public void test_addDoubleAndDoubleFloatShortByteFromUnion() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_DOUBLE, unionLayout);
		MemorySegment functionSymbol = nativeLibLookup.find("addDoubleAndDoubleFloatShortByteFromUnion").get();
		MethodHandle mh = linker.downcallHandle(functionSymbol, fd);

		try (Arena arena = Arena.ofConfined()) {
			MemorySegment unionSegmt = arena.allocate(unionLayout);
			elemHandle1.set(unionSegmt, 200.1D);
			elemHandle2.set(unionSegmt, 1.001F);
			elemHandle3.set(unionSegmt, (short)32766);
			elemHandle4.set(unionSegmt, (byte)22);
			Assert.assertEquals((double)elemHandle1.get(unionSegmt), 200.1D, 0.1D);
			Assert.assertEquals((float)elemHandle2.get(unionSegmt), 1.0F, 0.1F);
			Assert.assertEquals((short)elemHandle3.get(unionSegmt), 32534);

			double result = (double)mh.invokeExact(33333.567D, unionSegmt);
			Assert.assertEquals(result, 66090.7D, 0.1D);
		}
	}
}
