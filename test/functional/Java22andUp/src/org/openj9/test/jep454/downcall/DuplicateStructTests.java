...
public class DuplicateStructTests {
	...
	public void test_addByteStruct1AndNestedByteStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			Assert.assertEquals((byte)byteHandle2.get(resultSegmt, 0L), (byte)68);
		}
	}
	...
	public void test_addByteStruct1AndNestedByteArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((byte)byteHandle1.get(resultSegmt, 0L), (byte)36);
	...
	public void test_addByteStruct1AndNestedByteStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((byte)byteHandle1.get(resultSegmt, 0L), (byte)71);
			Assert.assertEquals((byte)byteHandle2.get(resultSegmt, 0L), (byte)90);
		}
	}
	...
	public void test_addCharStructs_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			MemorySegment structSegmt1 = arena.allocate(structLayout);
			charHandle1.set(structSegmt1, 0, 'A');
			charHandle2.set(structSegmt1, 0, 'B');
			MemorySegment structSegmt2 = arena.allocate(structLayout);
			charHandle1.set(structSegmt2, 0, 'C');
			charHandle2.set(structSegmt2, 0, 'D');

			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals(charHandle1.get(resultSegmt, 0), 'C');
			Assert.assertEquals(charHandle2.get(resultSegmt, 0), 'E');
		}
	}
	...
	public void test_addCharStruct1AndNestedCharStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals(charHandle1.get(resultSegmt, 0), 'E');
			Assert.assertEquals(charHandle2.get(resultSegmt, 0), 'M');
		}
	}
	...
	public void test_addCharStruct1AndNestedCharStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals(charHandle1.get(resultSegmt, 0), 'M');
			Assert.assertEquals(charHandle2.get(resultSegmt, 0), 'Y');
		}
	}
	...
	public void test_addShortStruct1AndNestedShortStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((short)shortHandle1.get(resultSegmt, 0L), (short)87);
			Assert.assertEquals((short)shortHandle2.get(resultSegmt, 0L), (short)113);
		}
	}
	...
	public void test_addShortStruct1AndNestedShortArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			MemorySegment structSegmt1 = arena.allocate(structLayout1);
			shortHandle1.set(structSegmt1, 0L, (short)156);
			shortHandle2.set(structSegmt1, 0L, (short)145);
			MemorySegment structSegmt2 = arena.allocate(structLayout2);
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((short)shortHandle1.get(resultSegmt, 0L), (short)267);
			Assert.assertEquals((short)shortHandle2.get(resultSegmt, 0L), (short)700);
		}
	}
	...
	public void test_addShortStruct1AndNestedShortStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((short)shortHandle1.get(resultSegmt, 0L), (short)600);
			Assert.assertEquals((short)shortHandle2.get(resultSegmt, 0L), (short)1366);
		}
	}
	...
	public void test_addIntStruct1AndNestedIntStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals(intHandle1.get(resultSegmt, 0L), 32445668);
			Assert.assertEquals(intHandle2.get(resultSegmt, 0L), 110233648);
		}
	}
	...
	public void test_addLongStruct1AndNestedLongStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals(longHandle1.get(resultSegmt, 0L), 988765433098L);
			Assert.assertEquals(longHandle2.get(resultSegmt, 0L), 129012344678L);
		}
	}
	...
	public void test_addLongStruct1AndNestedLongStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals(longHandle1.get(resultSegmt, 0L), 988098766431L);
			Assert.assertEquals(longHandle2.get(resultSegmt, 0L), 124279011344L);
		}
	}
	...
	public void test_addFloatStruct1AndNestedFloatStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((float)floatHandle1.get(resultSegmt, 0L), 56.34F, 0.01F);
			Assert.assertEquals((float)floatHandle2.get(resultSegmt, 0L), 80.33F, 0.01F);
		}
	}
	...
	public void test_addFloatStruct1AndNestedFloatArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((float)floatHandle1.get(resultSegmt, 0L), 136.23F, 0.01F);
			Assert.assertEquals((float)floatHandle2.get(resultSegmt, 0L), 566.78F, 0.01F);
		}
	}
	...
	public void test_addFloatStruct1AndNestedFloatStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((float)floatHandle1.get(resultSegmt, 0L), 469.61F, 0.01F);
			Assert.assertEquals((float)floatHandle2.get(resultSegmt, 0L), 833.44F, 0.01F);
		}
	}
	...
	public void test_addDoubleStruct1AndNestedDoubleStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((double)doubleHandle1.get(resultSegmt, 0L), 43.011D, 0.001D);
			Assert.assertEquals((double)doubleHandle2.get(resultSegmt, 0L), 90.912D, 0.001D);
		}
	}
	...
	public void test_addDoubleStruct1AndNestedDoubleStructArrayStruct2_returnStruct1_dupStruct() throws Throwable {
		...
		try (Arena arena = Arena.ofConfined()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact((SegmentAllocator)arena, structSegmt1, structSegmt2);
			Assert.assertEquals((double)doubleHandle1.get(resultSegmt, 0L), 866.67D, 0.001D);
			Assert.assertEquals((double)doubleHandle2.get(resultSegmt, 0L), 853.555D, 0.001D);
		}
	}
