...
/**
 * Test cases for JEP 389: Foreign Linker API (Incubator) UpCall for argument/return struct.
 *
...
public class UpCallMHWithStructTests {
	...
	public void test_addBoolAndBoolsFromStructWithXorByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromStructWithXorByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		boolHandle1.set(structSegmt, 0);
		boolHandle2.set(structSegmt, 1);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromStructWithXor,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		boolean result = (boolean)mh.invokeExact(false, structSegmt, upcallFunc.address());
	...
	public void test_addBoolFromPointerAndBoolsFromStructWithXorByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addBoolFromPointerAndBoolsFromStructWithXorByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		boolHandle1.set(structSegmt, 0);
		boolHandle2.set(structSegmt, 1);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolFromPointerAndBoolsFromStructWithXor,
				FunctionDescriptor.of(C_INT, C_POINTER, structLayout));

		boolean result = (boolean)mh.invokeExact(booleanSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addBoolFromPointerAndBoolsFromStructWithXor_returnBoolPointerByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addBoolFromPointerAndBoolsFromStructWithXor_returnBoolPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolFromPointerAndBoolsFromStructWithXor_returnBoolPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(booleanSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addBoolAndBoolsFromStructPointerWithXorByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromStructPointerWithXorByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		boolHandle1.set(structSegmt, 1);
		boolHandle2.set(structSegmt, 0);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromStructPointerWithXor,
				FunctionDescriptor.of(C_INT, C_INT, C_POINTER));

		boolean result = (boolean)mh.invokeExact(false, structSegmt.address(), upcallFunc.address());
		Assert.assertEquals(result, true);
		structSegmt.close();
	}
	...
	public void test_addBoolAndBoolsFromNestedStructWithXorByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(boolean.class, boolean.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromNestedStructWithXorByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromNestedStructWithXor,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		boolean result = (boolean)mh.invokeExact(true, structSegmt, upcallFunc.address());
		Assert.assertEquals(result, true);
		structSegmt.close();
	}
	...
	public void test_addBoolAndBoolsFromNestedStructWithXor_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(boolean.class, boolean.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromNestedStructWithXor_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setIntAtOffset(structSegmt, 4, 0);
		MemoryAccess.setIntAtOffset(structSegmt, 8, 1);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromNestedStructWithXor_reverseOrder,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));
	...
	public void test_addBoolAndBoolsFromStructWithNestedBoolArrayByUpCallMH() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromStructWithNestedBoolArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromStructWithNestedBoolArray,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(0, structSegmt, upcallFunc.address());
		Assert.assertEquals(result, 1);
		structSegmt.close();
	}
	...
	public void test_addBoolAndBoolsFromStructWithNestedBoolArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromStructWithNestedBoolArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setIntAtOffset(structSegmt, 4, 1);
		MemoryAccess.setIntAtOffset(structSegmt, 8, 0);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromStructWithNestedBoolArray_reverseOrder,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));
	...
	public void test_addBoolAndBoolsFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromStructWithNestedStructArray,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(1, structSegmt, upcallFunc.address());
		Assert.assertEquals(result, 1);
		structSegmt.close();
	}
	...
	public void test_addBoolAndBoolsFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addBoolAndBoolsFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setIntAtOffset(structSegmt, 12, 1);
		MemoryAccess.setIntAtOffset(structSegmt, 16, 0);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addBoolAndBoolsFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));
	...
	public void test_add2BoolStructsWithXor_returnStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("add2BoolStructsWithXor_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2BoolStructsWithXor_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));

		MemorySegment resultSegmt = (MemorySegment)mh.invokeExact(structSegmt1, structSegmt2, upcallFunc.address());
	...
	public void test_add2BoolStructsWithXor_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2BoolStructsWithXor_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		boolHandle1.set(structSegmt2, 1);
		boolHandle2.set(structSegmt2, 1);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2BoolStructsWithXor_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(structSegmt1.address(), structSegmt2, upcallFunc.address());
	...
	public void test_add3BoolStructsWithXor_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3BoolStructsWithXor_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3BoolStructsWithXor_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	*/
	...
	public void test_addByteAndBytesFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		byteHandle1.set(structSegmt, (byte)8);
		byteHandle2.set(structSegmt, (byte)9);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromStruct,
				FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout));


		byte result = (byte)mh.invokeExact((byte)6, structSegmt, upcallFunc.address());
	...
	public void test_addByteFromPointerAndBytesFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addByteFromPointerAndBytesFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteFromPointerAndBytesFromStruct,
				FunctionDescriptor.of(C_CHAR, C_POINTER, structLayout));

		byte result = (byte)mh.invokeExact(byteSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addByteFromPointerAndBytesFromStruct_returnBytePointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addByteFromPointerAndBytesFromStruct_returnBytePointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteFromPointerAndBytesFromStruct_returnBytePointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(byteSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addByteAndBytesFromStructPointerByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		byteHandle1.set(structSegmt, (byte)11);
		byteHandle2.set(structSegmt, (byte)12);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromStructPointer,
				FunctionDescriptor.of(C_CHAR, C_CHAR, C_POINTER));

		byte result = (byte)mh.invokeExact((byte)13, structSegmt.address(), upcallFunc.address());
	...
	public void test_addByteAndBytesFromNestedStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(byte.class, byte.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromNestedStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromNestedStruct,
				FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout));

		byte result = (byte)mh.invokeExact((byte)46, structSegmt, upcallFunc.address());
	...
	public void test_addByteAndBytesFromNestedStruct_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(byte.class, byte.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromNestedStruct_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromNestedStruct_reverseOrder,
				FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout));

		byte result = (byte)mh.invokeExact((byte)48, structSegmt, upcallFunc.address());
	...
	public void test_addByteAndBytesFromStructWithNestedByteArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(byte.class, byte.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromStructWithNestedByteArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromStructWithNestedByteArray,
				FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout));

		byte result = (byte)mh.invokeExact((byte)14, structSegmt, upcallFunc.address());
	...
	public void test_addByteAndBytesFromStructWithNestedByteArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(byte.class, byte.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromStructWithNestedByteArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromStructWithNestedByteArray_reverseOrder,
				FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout));

		byte result = (byte)mh.invokeExact((byte)18, structSegmt, upcallFunc.address());
	...
	public void test_addByteAndBytesFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(byte.class, byte.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromStructWithNestedStructArray,
				FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout));

		byte result = (byte)mh.invokeExact((byte)16, structSegmt, upcallFunc.address());
	...
	public void test_addByteAndBytesFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(byte.class, byte.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addByteAndBytesFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addByteAndBytesFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(C_CHAR, C_CHAR, structLayout));

		byte result = (byte)mh.invokeExact((byte)22, structSegmt, upcallFunc.address());
	...
	public void test_add2ByteStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2ByteStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2ByteStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_add2ByteStructs_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2ByteStructs_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		byteHandle1.set(structSegmt2, (byte)24);
		byteHandle2.set(structSegmt2, (byte)13);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2ByteStructs_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));
	...
	public void test_add3ByteStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3ByteStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3ByteStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_addCharAndCharsFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		charHandle1.set(structSegmt, 'A');
		charHandle2.set(structSegmt, 'B');
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromStruct,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		char result = (char)mh.invokeExact('C', structSegmt, upcallFunc.address());
	...
	public void test_addCharFromPointerAndCharsFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addCharFromPointerAndCharsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharFromPointerAndCharsFromStruct,
				FunctionDescriptor.of(C_SHORT, C_POINTER, structLayout));

		char result = (char)mh.invokeExact(charSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addCharFromPointerAndCharsFromStruct_returnCharPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addCharFromPointerAndCharsFromStruct_returnCharPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		charHandle1.set(structSegmt, 'E');
		charHandle2.set(structSegmt, 'F');
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharFromPointerAndCharsFromStruct_returnCharPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(charSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addCharAndCharsFromStructPointerByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		charHandle1.set(structSegmt, 'H');
		charHandle2.set(structSegmt, 'I');
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromStructPointer,
				FunctionDescriptor.of(C_SHORT, C_SHORT, C_POINTER));

		char result = (char)mh.invokeExact('G', structSegmt.address(), upcallFunc.address());
	...
	public void test_addCharAndCharsFromNestedStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(char.class, char.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromNestedStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromNestedStruct,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		char result = (char)mh.invokeExact('H', structSegmt, upcallFunc.address());
	...
	public void test_addCharAndCharsFromNestedStruct_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(char.class, char.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromNestedStruct_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setCharAtOffset(structSegmt, 2, 'F');
		MemoryAccess.setCharAtOffset(structSegmt, 4, 'G');
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromNestedStruct_reverseOrder,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));
	...
	public void test_addCharAndCharsFromStructWithNestedCharArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(char.class, char.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromStructWithNestedCharArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromStructWithNestedCharArray,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		char result = (char)mh.invokeExact('D', structSegmt, upcallFunc.address());
	...
	public void test_addCharAndCharsFromStructWithNestedCharArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(char.class, char.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromStructWithNestedCharArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setCharAtOffset(structSegmt, 2, 'B');
		MemoryAccess.setCharAtOffset(structSegmt, 4, 'C');
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromStructWithNestedCharArray_reverseOrder,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));
	...
	public void test_addCharAndCharsFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(char.class, char.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromStructWithNestedStructArray,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		char result = (char)mh.invokeExact('J', structSegmt, upcallFunc.address());
	...
	public void test_addCharAndCharsFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(char.class, char.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addCharAndCharsFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setCharAtOffset(structSegmt, 6, 'H');
		MemoryAccess.setCharAtOffset(structSegmt, 8, 'I');
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addCharAndCharsFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));
	...
	public void test_add2CharStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2CharStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2CharStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_add2CharStructs_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2CharStructs_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		charHandle1.set(structSegmt2, 'C');
		charHandle2.set(structSegmt2, 'D');
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2CharStructs_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));
	...
	public void test_add3CharStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3CharStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3CharStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_addShortAndShortsFromStructByUpCallMH() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		shortHandle1.set(structSegmt, (short)8);
		shortHandle2.set(structSegmt, (short)9);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromStruct,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		short result = (short)mh.invokeExact((short)6, structSegmt, upcallFunc.address());
		Assert.assertEquals(result, 23);
		structSegmt.close();
	}
	...
	public void test_addShortFromPointerAndShortsFromStructByUpCallMH() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortFromPointerAndShortsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortFromPointerAndShortsFromStruct,
				FunctionDescriptor.of(C_SHORT, C_POINTER, structLayout));

		short result = (short)mh.invokeExact(shortSegmt.address(), structSegmt, upcallFunc.address());
		Assert.assertEquals(result, 49);
		shortSegmt.close();
		structSegmt.close();
	}
	...
	public void test_addShortFromPointerAndShortsFromStruct_returnShortPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortFromPointerAndShortsFromStruct_returnShortPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		shortHandle1.set(structSegmt, (short)18);
		shortHandle2.set(structSegmt, (short)19);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortFromPointerAndShortsFromStruct_returnShortPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(shortSegmt.address(), structSegmt, upcallFunc.address());
		MemorySegment resultSegmt = resultAddr.asSegmentRestricted(C_SHORT.byteSize());
	...
	public void test_addShortAndShortsFromStructPointerByUpCallMH() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, C_POINTER, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		shortHandle1.set(structSegmt, (short)22);
		shortHandle2.set(structSegmt, (short)44);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromStructPointer,
				FunctionDescriptor.of(C_SHORT, C_SHORT, C_POINTER));

		short result = (short)mh.invokeExact((short)66, structSegmt.address(), upcallFunc.address());
	...
	public void test_addShortAndShortsFromNestedStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(short.class, short.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromNestedStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromNestedStruct,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		short result = (short)mh.invokeExact((short)37, structSegmt, upcallFunc.address());
	...
	public void test_addShortAndShortsFromNestedStruct_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(short.class, short.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromNestedStruct_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setShortAtOffset(structSegmt, 2, (short)33);
		MemoryAccess.setShortAtOffset(structSegmt, 4, (short)35);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromNestedStruct_reverseOrder,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));
	...
	public void test_addShortAndShortsFromStructWithNestedShortArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(short.class, short.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromStructWithNestedShortArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromStructWithNestedShortArray,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		short result = (short)mh.invokeExact((short)444, structSegmt, upcallFunc.address());
	...
	public void test_addShortAndShortsFromStructWithNestedShortArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(short.class, short.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromStructWithNestedShortArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setShortAtOffset(structSegmt, 2, (short)222);
		MemoryAccess.setShortAtOffset(structSegmt, 4, (short)333);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromStructWithNestedShortArray_reverseOrder,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));
	...
	public void test_addShortAndShortsFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(short.class, short.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromStructWithNestedStructArray,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));

		short result = (short)mh.invokeExact((short)666, structSegmt, upcallFunc.address());
	...
	public void test_addShortAndShortsFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(short.class, short.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addShortAndShortsFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setShortAtOffset(structSegmt, 6, (short)444);
		MemoryAccess.setShortAtOffset(structSegmt, 8, (short)555);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addShortAndShortsFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(C_SHORT, C_SHORT, structLayout));
	...
	public void test_add2ShortStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2ShortStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2ShortStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_add2ShortStructs_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2ShortStructs_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		shortHandle1.set(structSegmt2, (short)78);
		shortHandle2.set(structSegmt2, (short)67);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2ShortStructs_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));
	...
	public void test_add3ShortStructs_returnStructByUpCallMH() throws Throwable  {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3ShortStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3ShortStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_addIntAndIntsFromStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		intHandle1.set(structSegmt, 1122334);
		intHandle2.set(structSegmt, 1234567);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromStruct,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(2244668, structSegmt, upcallFunc.address());
	...
	public void test_addIntAndIntShortFromStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntShortFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		elemHandle1.set(structSegmt, 11223344);
		elemHandle2.set(structSegmt, (short)32766);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntShortFromStruct,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(22334455, structSegmt, upcallFunc.address());
	...
	public void test_addIntAndShortIntFromStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndShortIntFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		elemHandle1.set(structSegmt, (short)32766);
		elemHandle2.set(structSegmt, 22446688);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndShortIntFromStruct,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(11335577, structSegmt, upcallFunc.address());
	...
	public void test_addIntFromPointerAndIntsFromStructByUpCallMH() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntFromPointerAndIntsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntFromPointerAndIntsFromStruct,
				FunctionDescriptor.of(C_INT, C_POINTER, structLayout));

		int result = (int)mh.invokeExact(intSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addIntFromPointerAndIntsFromStruct_returnIntPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntFromPointerAndIntsFromStruct_returnIntPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntFromPointerAndIntsFromStruct_returnIntPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(intSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addIntAndIntsFromStructPointerByUpCallMH() throws Throwable {
		...
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, C_POINTER, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		intHandle1.set(structSegmt, 11121314);
		intHandle2.set(structSegmt, 15161718);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromStructPointer,
				FunctionDescriptor.of(C_INT, C_INT, C_POINTER));

		int result = (int)mh.invokeExact(19202122, structSegmt.address(), upcallFunc.address());
	...
	public void test_addIntAndIntsFromNestedStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromNestedStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromNestedStruct,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(33343536, structSegmt, upcallFunc.address());
	...
	public void test_addIntAndIntsFromNestedStruct_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromNestedStruct_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setIntAtOffset(structSegmt, 4, 25262728);
		MemoryAccess.setIntAtOffset(structSegmt, 8, 29303132);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromNestedStruct_reverseOrder,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));
	...
	public void test_addIntAndIntsFromStructWithNestedIntArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromStructWithNestedIntArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromStructWithNestedIntArray,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(4444444, structSegmt, upcallFunc.address());
	...
	public void test_addIntAndIntsFromStructWithNestedIntArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromStructWithNestedIntArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setIntAtOffset(structSegmt, 4, 2222222);
		MemoryAccess.setIntAtOffset(structSegmt, 8, 3333333);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromStructWithNestedIntArray_reverseOrder,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));
	...
	public void test_addIntAndIntsFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromStructWithNestedStructArray,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));

		int result = (int)mh.invokeExact(6666666, structSegmt, upcallFunc.address());
	...
	public void test_addIntAndIntsFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(int.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_INT, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntsFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setIntAtOffset(structSegmt, 12, 4444444);
		MemoryAccess.setIntAtOffset(structSegmt, 16, 5555555);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntsFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(C_INT, C_INT, structLayout));
	...
	public void test_add2IntStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2IntStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2IntStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_add2IntStructs_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2IntStructs_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		intHandle1.set(structSegmt2, 99001122);
		intHandle2.set(structSegmt2, 33445566);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2IntStructs_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));
	...
	public void test_add3IntStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3IntStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3IntStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_addLongAndLongsFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		longHandle1.set(structSegmt, 1234567890L);
		longHandle2.set(structSegmt, 9876543210L);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromStruct,
				FunctionDescriptor.of(longLayout, longLayout, structLayout));

		long result = (long)mh.invokeExact(2468024680L, structSegmt, upcallFunc.address());
	...
	public void test_addIntAndIntLongFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addIntAndIntLongFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		elemHandle1.set(structSegmt, 11223344);
		elemHandle2.set(structSegmt, 667788990011L);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndIntLongFromStruct,
				FunctionDescriptor.of(longLayout, C_INT, structLayout));

		long result = (long)mh.invokeExact(22446688, structSegmt, upcallFunc.address());
	...
	public void test_addIntAndLongIntFromStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(long.class, int.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(longLayout, C_INT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addIntAndLongIntFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		elemHandle1.set(structSegmt, 667788990011L);
		elemHandle2.set(structSegmt, 11223344);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addIntAndLongIntFromStruct,
				FunctionDescriptor.of(longLayout, C_INT, structLayout));

		long result = (long)mh.invokeExact(1234567, structSegmt, upcallFunc.address());
	...
	public void test_addLongFromPointerAndLongsFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addLongFromPointerAndLongsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongFromPointerAndLongsFromStruct,
				FunctionDescriptor.of(longLayout, C_POINTER, structLayout));

		long result = (long)mh.invokeExact(longSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addLongFromPointerAndLongsFromStruct_returnLongPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addLongFromPointerAndLongsFromStruct_returnLongPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongFromPointerAndLongsFromStruct_returnLongPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(longSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addLongAndLongsFromStructPointerByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		longHandle1.set(structSegmt, 224466880022L);
		longHandle2.set(structSegmt, 446688002244L);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromStructPointer,
				FunctionDescriptor.of(longLayout, longLayout, C_POINTER));

		long result = (long)mh.invokeExact(668800224466L, structSegmt.address(), upcallFunc.address());
	...
	public void test_addLongAndLongsFromNestedStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(long.class, long.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(longLayout, longLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromNestedStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromNestedStruct,
				FunctionDescriptor.of(longLayout, longLayout, structLayout));

		long result = (long)mh.invokeExact(778899001122L, structSegmt, upcallFunc.address());
	...
	public void test_addLongAndLongsFromNestedStruct_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(long.class, long.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(longLayout, longLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromNestedStruct_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setLongAtOffset(structSegmt, 8, 246802468024L);
		MemoryAccess.setLongAtOffset(structSegmt, 16,112233445566L);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromNestedStruct_reverseOrder,
				FunctionDescriptor.of(longLayout, longLayout, structLayout));
	...
	public void test_addLongAndLongsFromStructWithNestedLongArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(long.class, long.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(longLayout, longLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromStructWithNestedLongArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromStructWithNestedLongArray,
				FunctionDescriptor.of(longLayout, longLayout, structLayout));

		long result = (long)mh.invokeExact(444444444L, structSegmt, upcallFunc.address());
	...
	public void test_addLongAndLongsFromStructWithNestedLongArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(long.class, long.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(longLayout, longLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromStructWithNestedLongArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setLongAtOffset(structSegmt, 8, 222222222L);
		MemoryAccess.setLongAtOffset(structSegmt, 16, 333333333L);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromStructWithNestedLongArray_reverseOrder,
				FunctionDescriptor.of(longLayout, longLayout, structLayout));
	...
	public void test_addLongAndLongsFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(long.class, long.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(longLayout, longLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromStructWithNestedStructArray,
				FunctionDescriptor.of(longLayout, longLayout, structLayout));

		long result = (long)mh.invokeExact(666666666L, structSegmt, upcallFunc.address());
	...
	public void test_addLongAndLongsFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(long.class, long.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(longLayout, longLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addLongAndLongsFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setLongAtOffset(structSegmt, 24, 444444444L);
		MemoryAccess.setLongAtOffset(structSegmt, 32, 555555555L);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addLongAndLongsFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(longLayout, longLayout, structLayout));
	...
	public void test_add2LongStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2LongStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2LongStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_add2LongStructs_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2LongStructs_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2LongStructs_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));
	...
	public void test_add3LongStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3LongStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3LongStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_addFloatAndFloatsFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		floatHandle1.set(structSegmt, 8.12F);
		floatHandle2.set(structSegmt, 9.24F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromStruct,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout));

		float result = (float)mh.invokeExact(6.56F, structSegmt, upcallFunc.address());
	...
	public void test_addFloatFromPointerAndFloatsFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addFloatFromPointerAndFloatsFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatFromPointerAndFloatsFromStruct,
				FunctionDescriptor.of(C_FLOAT, C_POINTER, structLayout));

		float result = (float)mh.invokeExact(floatSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addFloatFromPointerAndFloatsFromStruct_returnFloatPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addFloatFromPointerAndFloatsFromStruct_returnFloatPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		floatHandle1.set(structSegmt, 18.23F);
		floatHandle2.set(structSegmt, 19.34F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatFromPointerAndFloatsFromStruct_returnFloatPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(floatSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addFloatAndFloatsFromStructPointerByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		floatHandle1.set(structSegmt, 35.11F);
		floatHandle2.set(structSegmt, 46.22F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromStructPointer,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, C_POINTER));

		float result = (float)mh.invokeExact(79.33F, structSegmt.address(), upcallFunc.address());
	...
	public void test_addFloatAndFloatsFromNestedStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(float.class, float.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromNestedStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromNestedStruct,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout));

		float result = (float)mh.invokeExact(37.88F, structSegmt, upcallFunc.address());
	...
	public void test_addFloatAndFloatsFromNestedStruct_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(float.class, float.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromNestedStruct_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setFloatAtOffset(structSegmt, 4, 33.44F);
		MemoryAccess.setFloatAtOffset(structSegmt, 8, 35.66F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromNestedStruct_reverseOrder,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout));
	...
	public void test_addFloatAndFloatsFromStructWithNestedFloatArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(float.class, float.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromStructWithNestedFloatArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromStructWithNestedFloatArray,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout));

		float result = (float)mh.invokeExact(444.44F, structSegmt, upcallFunc.address());
	...
	public void test_addFloatAndFloatsFromStructWithNestedFloatArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(float.class, float.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromStructWithNestedFloatArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setFloatAtOffset(structSegmt, 4, 222.22F);
		MemoryAccess.setFloatAtOffset(structSegmt, 8, 333.33F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromStructWithNestedFloatArray_reverseOrder,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout));
	...
	public void test_addFloatAndFloatsFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(float.class, float.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromStructWithNestedStructArray,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout));

		float result = (float)mh.invokeExact(666.66F, structSegmt, upcallFunc.address());
	...
	public void test_addFloatAndFloatsFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(float.class, float.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addFloatAndFloatsFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setFloatAtOffset(structSegmt, 12, 444.44F);
		MemoryAccess.setFloatAtOffset(structSegmt, 16, 555.55F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addFloatAndFloatsFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(C_FLOAT, C_FLOAT, structLayout));
	...
	public void test_add2FloatStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2FloatStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2FloatStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_add2FloatStructs_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2FloatStructs_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		floatHandle1.set(structSegmt2, 24.34F);
		floatHandle2.set(structSegmt2, 13.45F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2FloatStructs_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));
	...
	public void test_add3FloatStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3FloatStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3FloatStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_addDoubleAndDoublesFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		doubleHandle1.set(structSegmt, 2228.111D);
		doubleHandle2.set(structSegmt, 2229.221D);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromStruct,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));

		double result = (double)mh.invokeExact(3336.333D, structSegmt, upcallFunc.address());
	...
	public void test_addDoubleAndFloatDoubleFromStructByUpCallMH() throws Throwable {
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndFloatDoubleFromStruct,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));

		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndFloatDoubleFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		double result = (double)mh.invokeExact(113.567D, structSegmt, upcallFunc.address());
	...
	public void test_addDoubleAndIntDoubleFromStructByUpCallMH() throws Throwable {
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndIntDoubleFromStruct,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));

		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndIntDoubleFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
	...
	public void test_addDoubleAndDoubleFloatFromStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoubleFloatFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		elemHandle1.set(structSegmt, 218.555D);
		elemHandle2.set(structSegmt, 19.22F);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoubleFloatFromStruct,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));

		double result = (double)mh.invokeExact(216.666D, structSegmt, upcallFunc.address());
	...
	public void test_addDoubleAndDoubleIntFromStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoubleIntFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		elemHandle1.set(structSegmt, 218.555D);
		elemHandle2.set(structSegmt, 19);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoubleIntFromStruct,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));
	...
	public void test_addDoubleFromPointerAndDoublesFromStructByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addDoubleFromPointerAndDoublesFromStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleFromPointerAndDoublesFromStruct,
				FunctionDescriptor.of(C_DOUBLE, C_POINTER, structLayout));

		double result = (double)mh.invokeExact(doubleSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addDoubleFromPointerAndDoublesFromStruct_returnDoublePointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleFromPointerAndDoublesFromStruct_returnDoublePointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleFromPointerAndDoublesFromStruct_returnDoublePointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));

		MemoryAddress resultAddr = (MemoryAddress)mh.invokeExact(doubleSegmt.address(), structSegmt, upcallFunc.address());
	...
	public void test_addDoubleAndDoublesFromStructPointerByUpCallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);

		MemorySegment structSegmt = MemorySegment.allocateNative(structLayout);
		doubleHandle1.set(structSegmt, 22.111D);
		doubleHandle2.set(structSegmt, 44.222D);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromStructPointer,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, C_POINTER));

		double result = (double)mh.invokeExact(66.333D, structSegmt.address(), upcallFunc.address());
	...
	public void test_addDoubleAndDoublesFromNestedStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromNestedStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromNestedStruct,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));

		double result = (double)mh.invokeExact(37.864D, structSegmt, upcallFunc.address());
	...
	public void test_addDoubleAndDoublesFromNestedStruct_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromNestedStruct_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setDoubleAtOffset(structSegmt, 8, 33.456D);
		MemoryAccess.setDoubleAtOffset(structSegmt, 16, 35.123D);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromNestedStruct_reverseOrder,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));
	...
	public void test_addDoubleAndDoublesFromStructWithNestedDoubleArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromStructWithNestedDoubleArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromStructWithNestedDoubleArray,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));

		double result = (double)mh.invokeExact(444.444D, structSegmt, upcallFunc.address());
	...
	public void test_addDoubleAndDoublesFromStructWithNestedDoubleArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromStructWithNestedDoubleArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setDoubleAtOffset(structSegmt, 8, 222.222D);
		MemoryAccess.setDoubleAtOffset(structSegmt, 16, 333.333D);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromStructWithNestedDoubleArray_reverseOrder,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));
	...
	public void test_addDoubleAndDoublesFromStructWithNestedStructArrayByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromStructWithNestedStructArrayByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromStructWithNestedStructArray,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));

		double result = (double)mh.invokeExact(666.666D, structSegmt, upcallFunc.address());
	...
	public void test_addDoubleAndDoublesFromStructWithNestedStructArray_reverseOrderByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(double.class, double.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("addDoubleAndDoublesFromStructWithNestedStructArray_reverseOrderByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemoryAccess.setDoubleAtOffset(structSegmt, 24, 444.444D);
		MemoryAccess.setDoubleAtOffset(structSegmt, 32, 555.555D);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_addDoubleAndDoublesFromStructWithNestedStructArray_reverseOrder,
				FunctionDescriptor.of(C_DOUBLE, C_DOUBLE, structLayout));
	...
	public void test_add2DoubleStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2DoubleStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2DoubleStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
	...
	public void test_add2DoubleStructs_returnStructPointerByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemoryAddress.class, MemoryAddress.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add2DoubleStructs_returnStructPointerByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		doubleHandle1.set(structSegmt2, 33.444D);
		doubleHandle2.set(structSegmt2, 44.555D);
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add2DoubleStructs_returnStructPointer,
				FunctionDescriptor.of(C_POINTER, C_POINTER, structLayout));
	...
	public void test_add3DoubleStructs_returnStructByUpCallMH() throws Throwable {
		...
		MethodType mt = MethodType.methodType(MemorySegment.class, MemorySegment.class, MemorySegment.class, MemoryAddress.class);
		FunctionDescriptor fd = FunctionDescriptor.of(structLayout, structLayout, structLayout, C_POINTER);
		Symbol functionSymbol = nativeLib.lookup("add3DoubleStructs_returnStructByUpCallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
		...
		MemorySegment upcallFunc = clinker.upcallStub(UpCallMethodHandles.MH_add3DoubleStructs_returnStruct,
				FunctionDescriptor.of(structLayout, structLayout, structLayout));
