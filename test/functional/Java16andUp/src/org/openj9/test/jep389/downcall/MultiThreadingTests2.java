 ...
 * which verifies the downcalls with the diffrent layouts and argument/return types in multithreading.
 */
		...
		Thread thr2 =  new Thread(){
			public void run() {
				try {
					...
					Symbol functionSymbol = nativeLib.lookup("testAdd3Int").get();
					MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
