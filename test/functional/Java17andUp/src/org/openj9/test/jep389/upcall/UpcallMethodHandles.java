...
public class UpcallMethodHandles {
	...
	public static final MethodHandle MH_addLongAndLongFromPtr_RetPtr_ByUpcallMH;

	public static final MethodHandle MH_add2Floats;
	public static final MethodHandle MH_addFloatAndFloatFromPointer;
	public static final MethodHandle MH_addFloatAndFloatFromPtr_RetPtr_ByUpcallMH;
...
*/
	static {
		try {
			...
			MH_addBoolAndBoolFromPtrWithOr_RetPtr = lookup.findStatic(UpcallMethodHandles.class, "addBoolAndBoolFromPtrWithOr_RetPtr", methodType(MemoryAddress.class, boolean.class, MemoryAddress.class)); //$NON-NLS-1$
			...
			MH_createNewCharFromCharAndCharFromPtr_RetPtr = lookup.findStatic(UpcallMethodHandles.class, "createNewCharFromCharAndCharFromPtr_RetPtr", methodType(MemoryAddress.class, MemoryAddress.class, char.class)); //$NON-NLS-1$
			...
			MH_addByteAndByteFromPtr_RetPtr = lookup.findStatic(UpcallMethodHandles.class, "addByteAndByteFromPtr_RetPtr", methodType(MemoryAddress.class, byte.class, MemoryAddress.class)); //$NON-NLS-1$
			...
			MH_addShortAndShortFromPtr_RetPtr = lookup.findStatic(UpcallMethodHandles.class, "addShortAndShortFromPtr_RetPtr", methodType(MemoryAddress.class, MemoryAddress.class, short.class)); //$NON-NLS-1$
			...
			MH_addIntAndIntFromPtr_RetPtr = lookup.findStatic(UpcallMethodHandles.class, "addIntAndIntFromPtr_RetPtr", methodType(MemoryAddress.class, int.class, MemoryAddress.class)); //$NON-NLS-1$
			...
			MH_addLongAndLongFromPtr_RetPtr_ByUpcallMH = lookup.findStatic(UpcallMethodHandles.class, "addLongAndLongFromPtr_RetPtr", methodType(MemoryAddress.class, MemoryAddress.class, long.class)); //$NON-NLS-1$
			...
			MH_addFloatAndFloatFromPtr_RetPtr_ByUpcallMH = lookup.findStatic(UpcallMethodHandles.class, "addFloatAndFloatFromPtr_RetPtr", methodType(MemoryAddress.class, float.class, MemoryAddress.class)); //$NON-NLS-1$
			...
			MH_addDoubleAndDoubleFromPtr_RetPtr = lookup.findStatic(UpcallMethodHandles.class, "addDoubleAndDoubleFromPtr_RetPtr", methodType(MemoryAddress.class, MemoryAddress.class, double.class)); //$NON-NLS-1$
...
*/
	...
	public static boolean addBoolAndBoolFromPointerWithOr(boolean boolArg1, MemoryAddress boolArg2Addr) {
		int boolArg2 = MemoryAccess.getInt(boolArg2Addr.asSegment(C_INT.byteSize(), boolArg2Addr.scope()));
	...
	public static MemoryAddress addBoolAndBoolFromPtrWithOr_RetPtr(boolean boolArg1, MemoryAddress boolArg2Addr) {
		int boolArg2 = MemoryAccess.getInt(boolArg2Addr.asSegment(C_INT.byteSize(), boolArg2Addr.scope()));
		boolean result = boolArg1 || integerToBool(boolArg2);
		MemorySegment resultSegmt = MemorySegment.allocateNative(C_INT.byteSize(), boolArg2Addr.scope());
		MemoryAccess.setInt(resultSegmt, boolToInteger(result));
	...
	public static char createNewCharFromCharAndCharFromPointer(MemoryAddress charArg1Addr, char charArg2) {
		short charArg1 = MemoryAccess.getShort(charArg1Addr.asSegment(C_SHORT.byteSize(), charArg1Addr.scope()));
		int diff = (charArg2 >= charArg1) ? (charArg2 - charArg1) : (charArg1 - charArg2);
		diff = (diff > 5) ? 5 : diff;
		char result = (char)(diff + 'A');
		return result;
	...
	public static MemoryAddress createNewCharFromCharAndCharFromPtr_RetPtr(MemoryAddress charArg1Addr, char charArg2) {
		...
		diff = (diff > 5) ? 5 : diff;
		char result = (char)(diff + 'A');
		MemorySegment resultSegmt = MemorySegment.allocateNative(C_SHORT.byteSize(), charArg1Addr.scope());
	...
	public static byte addByteAndByteFromPointer(byte byteArg1, MemoryAddress byteArg2Addr) {
		byte byteArg2 = MemoryAccess.getByte(byteArg2Addr.asSegment(C_CHAR.byteSize(), byteArg2Addr.scope()));
		byte byteSum = (byte)(byteArg1 + byteArg2);
		return byteSum;
	}
	...
	public static MemoryAddress addByteAndByteFromPtr_RetPtr(byte byteArg1, MemoryAddress byteArg2Addr) {
		byte byteArg2 = MemoryAccess.getByte(byteArg2Addr.asSegment(C_CHAR.byteSize(), byteArg2Addr.scope()));
		byte byteSum = (byte)(byteArg1 + byteArg2);
		MemorySegment resultSegmt = MemorySegment.allocateNative(C_CHAR.byteSize(), byteArg2Addr.scope());
	...
	public static short addShortAndShortFromPointer(MemoryAddress shortArg1Addr, short shortArg2) {
		short shortArg1 = MemoryAccess.getShort(shortArg1Addr.asSegment(C_SHORT.byteSize(), shortArg1Addr.scope()));
		short shortSum = (short)(shortArg1 + shortArg2);
		return shortSum;
	}
	...
	public static MemoryAddress addShortAndShortFromPtr_RetPtr(MemoryAddress shortArg1Addr, short shortArg2) {
		short shortArg1 = MemoryAccess.getShort(shortArg1Addr.asSegment(C_SHORT.byteSize(), shortArg1Addr.scope()));
		short shortSum = (short)(shortArg1 + shortArg2);
		MemorySegment resultSegmt = MemorySegment.allocateNative(C_SHORT.byteSize(), shortArg1Addr.scope());
	...
	public static int addIntAndIntFromPointer(int intArg1, MemoryAddress intArg2Addr) {
		int intArg2 = MemoryAccess.getInt(intArg2Addr.asSegment(C_INT.byteSize(), intArg2Addr.scope()));
		int intSum = intArg1 + intArg2;
		return intSum;
	}
	...
	public static MemoryAddress addIntAndIntFromPtr_RetPtr(int intArg1, MemoryAddress intArg2Addr) {
		int intArg2 = MemoryAccess.getInt(intArg2Addr.asSegment(C_INT.byteSize(), intArg2Addr.scope()));
		int intSum = intArg1 + intArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(C_INT.byteSize(), intArg2Addr.scope());
	...
	public static long addLongAndLongFromPointer(MemoryAddress longArg1Addr, long longArg2) {
		long longArg1 = MemoryAccess.getLong(longArg1Addr.asSegment(longLayout.byteSize(), longArg1Addr.scope()));
		long longSum = longArg1 + longArg2;
		return longSum;
	}
	...
	public static MemoryAddress addLongAndLongFromPtr_RetPtr(MemoryAddress longArg1Addr, long longArg2) {
		long longArg1 = MemoryAccess.getLong(longArg1Addr.asSegment(longLayout.byteSize(), longArg1Addr.scope()));
		long longSum = longArg1 + longArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(longLayout.byteSize(), longArg1Addr.scope());
	...
	public static float addFloatAndFloatFromPointer(float floatArg1, MemoryAddress floatArg2Addr) {
		float floatArg2 = MemoryAccess.getFloat(floatArg2Addr.asSegment(C_FLOAT.byteSize(), floatArg2Addr.scope()));
		float floatSum = floatArg1 + floatArg2;
		return floatSum;
	}
	...
	public static MemoryAddress addFloatAndFloatFromPtr_RetPtr(float floatArg1, MemoryAddress floatArg2Addr) {
		float floatArg2 = MemoryAccess.getFloat(floatArg2Addr.asSegment(C_FLOAT.byteSize(), floatArg2Addr.scope()));
		float floatSum = floatArg1 + floatArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(C_FLOAT.byteSize(), floatArg2Addr.scope());
	...
	public static double addDoubleAndDoubleFromPointer(MemoryAddress doubleArg1Addr, double doubleArg2) {
		double doubleArg1 = MemoryAccess.getDouble(doubleArg1Addr.asSegment(C_DOUBLE.byteSize(), doubleArg1Addr.scope()));
		double doubleSum = doubleArg1 + doubleArg2;
		return doubleSum;
	}
	...
	public static MemoryAddress addDoubleAndDoubleFromPtr_RetPtr(MemoryAddress doubleArg1Addr, double doubleArg2) {
		double doubleArg1 = MemoryAccess.getDouble(doubleArg1Addr.asSegment(C_DOUBLE.byteSize(), doubleArg1Addr.scope()));
		double doubleSum = doubleArg1 + doubleArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(C_DOUBLE.byteSize(), doubleArg1Addr.scope());
		MemoryAccess.setDouble(resultSegmt, doubleSum);
		return resultSegmt.address();
	}

	public static int compare(MemoryAddress argAddr1, MemoryAddress argAddr2) {
		int intArg1 = MemoryAccess.getInt(argAddr1.asSegment(C_INT.byteSize(), argAddr1.scope()));
		int intArg2 = MemoryAccess.getInt(argAddr2.asSegment(C_INT.byteSize(), argAddr2.scope()));
