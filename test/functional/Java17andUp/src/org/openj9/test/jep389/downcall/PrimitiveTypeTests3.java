...
public class PrimitiveTypeTests3 {
	...
	@Test
	public void test_addIntsWithVaList_3() throws Throwable {
	...
	@Test
	public void test_addLongsWithVaList_3() throws Throwable {
	...
	@Test
	public void test_addDoublesWithVaList_3() throws Throwable {
	...
	@Test
	public void test_vprintfFromDefaultLibWithVaList_3() throws Throwable {
		...
		if (!isWinOS) {
			...
			MethodHandle mh = clinker.downcallHandle(mt, fd);
			mh.invoke(functionSymbol, formatMemSegment.address(), vaList);
		}
	}

	@Test
	public void test_vprintfFromDefaultLibWithVaList_fromMemAddr_3() throws Throwable {
		/* Disable the test on Windows given a misaligned access exception coming from
		 * java.base/java.lang.invoke.MemoryAccessVarHandleBase triggered by CLinker.toCString()
		 * is also captured on OpenJDK/Hotspot.
		 */
