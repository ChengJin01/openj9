...
/**
 * Test cases for JEP 389: Foreign Linker API (Incubator) Upcall intended for
...
public class MultiUpcallMHWithPrimitiveTests {
	...
	public void test_createNewCharFromCharAndCharFromPointerByUpcallMH_SameScope() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment shortSegmt1 = allocator.allocate(C_SHORT);
			MemoryAccess.setChar(shortSegmt1, 'B');
			char result = (char)mh.invokeExact(shortSegmt1.address(), 'D', upcallFuncAddr1);
			Assert.assertEquals(result, 'C');
			
			MemoryAddress upcallFuncAddr2 = clinker.upcallStub(UpcallMethodHandles.MH_createNewCharFromCharAndCharFromPointer,
					FunctionDescriptor.of(C_SHORT, C_POINTER, C_SHORT), scope);
			MemorySegment shortSegmt2 = allocator.allocate(C_SHORT);
			MemoryAccess.setChar(shortSegmt2, 'B');
			result = (char)mh.invokeExact(shortSegmt2.address(), 'D', upcallFuncAddr2);
			Assert.assertEquals(result, 'C');
			
			MemoryAddress upcallFuncAddr3 = clinker.upcallStub(UpcallMethodHandles.MH_createNewCharFromCharAndCharFromPointer,
					FunctionDescriptor.of(C_SHORT, C_POINTER, C_SHORT), scope);
			MemorySegment shortSegmt3 = allocator.allocate(C_SHORT);
			MemoryAccess.setChar(shortSegmt3, 'B');
			result = (char)mh.invokeExact(shortSegmt3.address(), 'D', upcallFuncAddr3);
			Assert.assertEquals(result, 'C');
		}
	}
	...
	public void test_addShortAndShortFromPtr_RetPtr_ByUpcallMH_SameScope() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment shortSegmt1 = allocator.allocate(C_SHORT);
			MemoryAccess.setShort(shortSegmt1, (short)444);
			MemoryAddress resultAddr1 = (MemoryAddress)mh.invokeExact(shortSegmt1.address(), (short)555, upcallFuncAddr1);
			...
			MemoryAddress upcallFuncAddr2 = clinker.upcallStub(UpcallMethodHandles.MH_addShortAndShortFromPtr_RetPtr,
					FunctionDescriptor.of(C_POINTER, C_POINTER, C_SHORT), scope);
			MemorySegment shortSegmt2 = allocator.allocate(C_SHORT);
			MemoryAccess.setShort(shortSegmt2, (short)444);
			MemoryAddress resultAddr2 = (MemoryAddress)mh.invokeExact(shortSegmt2.address(), (short)555, upcallFuncAddr2);
			...
			MemoryAddress upcallFuncAddr3 = clinker.upcallStub(UpcallMethodHandles.MH_addShortAndShortFromPtr_RetPtr,
					FunctionDescriptor.of(C_POINTER, C_POINTER, C_SHORT), scope);
			MemorySegment shortSegmt3 = allocator.allocate(C_SHORT);
			MemoryAccess.setShort(shortSegmt3, (short)444);
			MemoryAddress resultAddr3 = (MemoryAddress)mh.invokeExact(shortSegmt3.address(), (short)555, upcallFuncAddr3);
	...
	public void test_addLongAndLongFromPointerByUpcallMH_SameScope() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemoryAccess.setLong(longSegmt1, 57424L);
			long result = (long)mh.invokeExact(longSegmt1.address(), 698235L, upcallFuncAddr1);
			...
			MemoryAccess.setLong(longSegmt2, 57424L);
			result = (long)mh.invokeExact(longSegmt2.address(), 698235L, upcallFuncAddr2);
			Assert.assertEquals(result, 755659L);
			...
			MemoryAccess.setLong(longSegmt3, 57424L);
			result = (long)mh.invokeExact(longSegmt3.address(), 698235L, upcallFuncAddr3);
			Assert.assertEquals(result, 755659L);
		}
	}
	...
	public void test_addDoubleAndDoubleFromPtr_RetPtr_ByUpcallMH_SameScope() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemoryAccess.setDouble(doubleSegmt1, 1159.748d);
			MemoryAddress resultAddr1 = (MemoryAddress)mh.invokeExact(doubleSegmt1.address(), 1262.795d, upcallFuncAddr1);
			...
			MemoryAccess.setDouble(doubleSegmt2, 1159.748d);
			MemoryAddress resultAddr2 = (MemoryAddress)mh.invokeExact(doubleSegmt2.address(), 1262.795d, upcallFuncAddr2);
			...
			MemoryAccess.setDouble(doubleSegmt3, 1159.748d);
			MemoryAddress resultAddr3 = (MemoryAddress)mh.invokeExact(doubleSegmt3.address(), 1262.795d, upcallFuncAddr3);
