...
public class ApiTests {
	...
	public void test_emptyVaList() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			 ...
			 * the empty va_list on Windows while the va_list without any argument is
			 * created on a fixed address on other platforms.
			 */
			if (isWinOS) {
	...
	public void test_vaListSession() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			VaList vaList = CLinker.VaList.make(vaListBuilder -> vaListBuilder.vargFromInt(C_INT, 100), scope);
	...
	public void test_createIntPtrVaList() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(C_INT.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getInt(ptrSegmt), 700); // the 1st argument
			ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(C_INT.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getInt(ptrSegmt), 800); // the 2nd argument
			ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(C_INT.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getInt(ptrSegmt), 900); // the 3rd argument
		}
	}
	...
	public void test_createLongPtrVaList() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(longLayout.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getLong(ptrSegmt), 700000L); // the 1st argument
			ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(longLayout.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getLong(ptrSegmt), 800000L); // the 2nd argument
			ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(longLayout.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getLong(ptrSegmt), 900000L); // the 3rd argument
		}
	}
	...
	public void test_createDoublePtrVaList() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(C_DOUBLE.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getDouble(ptrSegmt), 111150.1001D, 0001D); // the 1st argument
			ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(C_DOUBLE.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getDouble(ptrSegmt), 111160.2002D, 0001D); // the 2nd argument
			ptrSegmt = newVaList.vargAsAddress(C_POINTER).asSegment(C_DOUBLE.byteSize(), scope);
			Assert.assertEquals(MemoryAccess.getDouble(ptrSegmt), 111170.1001D, 0001D); // the 3rd argument
		}
	}
	...
	public void test_skipIntPtrArgOfVaList() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment intSegmt2 = allocator.allocate(C_INT);
			MemorySegment intSegmt3 = allocator.allocate(C_INT);
			MemorySegment intSegmt4 = allocator.allocate(C_INT);
			MemoryAccess.setInt(intSegmt1, 700);
			MemoryAccess.setInt(intSegmt2, 800);
			MemoryAccess.setInt(intSegmt3, 900);
			MemoryAccess.setInt(intSegmt4, 1000);
	...
	public void test_skipLongPtrArgOfVaList() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment longSegmt2 = allocator.allocate(longLayout);
			MemorySegment longSegmt3 = allocator.allocate(longLayout);
			MemorySegment longSegmt4 = allocator.allocate(longLayout);
			MemoryAccess.setLong(longSegmt1, 700000L);
			MemoryAccess.setLong(longSegmt2, 800000L);
			MemoryAccess.setLong(longSegmt3, 900000L);
			MemoryAccess.setLong(longSegmt4, 1000000L);
	...
	public void test_skipDoublePtrArgOfVaList() throws Throwable {
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment doubleSegmt2 = allocator.allocate(C_DOUBLE);
			MemorySegment doubleSegmt3 = allocator.allocate(C_DOUBLE);
			MemorySegment doubleSegmt4 = allocator.allocate(C_DOUBLE);
			MemoryAccess.setDouble(doubleSegmt1, 111150.1001D);
			MemoryAccess.setDouble(doubleSegmt2, 111160.2002D);
			MemoryAccess.setDouble(doubleSegmt3, 111170.1001D);
			MemoryAccess.setDouble(doubleSegmt4, 111180.1002D);
			...
			Assert.assertEquals(vaList.vargAsAddress(C_POINTER), doubleSegmt4.address()); // the 4nd argument
		}
	}
