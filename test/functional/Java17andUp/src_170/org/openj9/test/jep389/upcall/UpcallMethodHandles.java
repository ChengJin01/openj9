...
public class UpcallMethodHandles {
	...
	public static final MethodHandle MH_addIntsByStructFromVaList;
	public static final MethodHandle MH_addLongsByStructFromVaList;
	public static final MethodHandle MH_addDoublesByStructFromVaList;
	...
	static {
		try {
			...
			MH_addIntsFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addIntsFromVaList", MT_Int_Int_MemAddr); //$NON-NLS-1$
			MH_addLongsFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addLongsFromVaList", MT_Long_Int_MemAddr); //$NON-NLS-1$
			MH_addDoublesFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addDoublesFromVaList", MT_Double_Int_MemAddr); //$NON-NLS-1$
			MH_addMixedArgsFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addMixedArgsFromVaList", methodType(double.class, MemoryAddress.class)); //$NON-NLS-1$
			MH_addIntsByPtrFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addIntsByPtrFromVaList", MT_Int_Int_MemAddr); //$NON-NLS-1$
			MH_addLongsByPtrFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addLongsByPtrFromVaList", MT_Long_Int_MemAddr); //$NON-NLS-1$
			MH_addDoublesByPtrFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addDoublesByPtrFromVaList", MT_Double_Int_MemAddr); //$NON-NLS-1$
			MH_addIntsByStructFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addIntsByStructFromVaList", MT_Int_Int_MemAddr); //$NON-NLS-1$
			MH_addLongsByStructFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addLongsByStructFromVaList", MT_Long_Int_MemAddr); //$NON-NLS-1$
			MH_addDoublesByStructFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addDoublesByStructFromVaList", MT_Double_Int_MemAddr); //$NON-NLS-1$
	...
	public static double addDoubleAndIntDoubleFloatFromStruct(double arg1, MemorySegment arg2) {
		...
		if (isAixOS) {
			...
			structElem1 = MemoryAccess.getIntAtOffset(arg2, 0);
			structElem2 = MemoryAccess.getDoubleAtOffset(arg2, 4);
			structElem3 = MemoryAccess.getFloatAtOffset(arg2, 12);
		} else {
			structLayout = MemoryLayout.structLayout(C_INT.withName("elem1"),
					MemoryLayout.paddingLayout(32), C_DOUBLE.withName("elem2"), C_FLOAT.withName("elem3"));
			VarHandle elemHandle1 = structLayout.varHandle(int.class, PathElement.groupElement("elem1"));
			VarHandle elemHandle2 = structLayout.varHandle(double.class, PathElement.groupElement("elem2"));
			VarHandle elemHandle3 = structLayout.varHandle(float.class, PathElement.groupElement("elem3"));
			structElem1 = (int)elemHandle1.get(arg2);
			structElem2 = (double)elemHandle2.get(arg2);
			structElem3 = (float)elemHandle3.get(arg2);
		}
	...
	public static double addDoubleAndFloatDoubleIntFromStruct(double arg1, MemorySegment arg2) {
		...
		if (isAixOS) {
			...
			structElem1 = MemoryAccess.getFloatAtOffset(arg2, 0);
			structElem2 = MemoryAccess.getDoubleAtOffset(arg2, 4);
			structElem3 = MemoryAccess.getIntAtOffset(arg2, 12);
		} else {
			structLayout = MemoryLayout.structLayout(C_FLOAT.withName("elem1"),
					MemoryLayout.paddingLayout(32), C_DOUBLE.withName("elem2"), C_INT.withName("elem3"));
			VarHandle elemHandle1 = structLayout.varHandle(float.class, PathElement.groupElement("elem1"));
			VarHandle elemHandle2 = structLayout.varHandle(double.class, PathElement.groupElement("elem2"));
			VarHandle elemHandle3 = structLayout.varHandle(int.class, PathElement.groupElement("elem3"));
			structElem1 = (float)elemHandle1.get(arg2);
			structElem2 = (double)elemHandle2.get(arg2);
			structElem3 = (int)elemHandle3.get(arg2);
		}
	...
	public static int addIntsByPtrFromVaList(int argCount, MemoryAddress ptrVaListAddr) {
		...
		int intSum = 0;
		while (argCount > 0) {
			MemorySegment ptrSegmt = ptrVaList.vargAsAddress(C_POINTER).asSegment(C_INT.byteSize(), scope);
			intSum += MemoryAccess.getInt(ptrSegmt);
			argCount--;
		}
		return intSum;
	}
	...
	public static long addLongsByPtrFromVaList(int argCount, MemoryAddress ptrVaListAddr) {
		...
		long longSum = 0;
		while (argCount > 0) {
			MemorySegment ptrSegmt = ptrVaList.vargAsAddress(C_POINTER).asSegment(longLayout.byteSize(), scope);
			longSum += MemoryAccess.getLong(ptrSegmt);
			argCount--;
		}
		return longSum;
	}
	...
	public static double addDoublesByPtrFromVaList(int argCount, MemoryAddress ptrVaListAddr) {
		...
		double doubleSum = 0;
		while (argCount > 0) {
			MemorySegment ptrSegmt = ptrVaList.vargAsAddress(C_POINTER).asSegment(C_DOUBLE.byteSize(), scope);
			doubleSum += MemoryAccess.getDouble(ptrSegmt);
			argCount--;
		}
		return doubleSum;
	}

	public static int addIntsByStructFromVaList(int argCount, MemoryAddress struVaListAddr) {
		GroupLayout structLayout = MemoryLayout.structLayout(C_INT.withName("elem1"), C_INT.withName("elem2"));
		VarHandle elemHandle1 = structLayout.varHandle(int.class, PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = structLayout.varHandle(int.class, PathElement.groupElement("elem2"));
		...
		while (argCount > 0) {
			MemorySegment argSegmt = struVaList.vargAsSegment(structLayout, scope);
	...
	public static long addLongsByStructFromVaList(int argCount, MemoryAddress struVaListAddr) {
		GroupLayout structLayout = MemoryLayout.structLayout(longLayout.withName("elem1"), longLayout.withName("elem2"));
		VarHandle elemHandle1 = structLayout.varHandle(long.class, PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = structLayout.varHandle(long.class, PathElement.groupElement("elem2"));
	...
	public static double addDoublesByStructFromVaList(int argCount, MemoryAddress struVaListAddr) {
		GroupLayout structLayout = MemoryLayout.structLayout(C_DOUBLE.withName("elem1"), C_DOUBLE.withName("elem2"));
		VarHandle elemHandle1 = structLayout.varHandle(double.class, PathElement.groupElement("elem1"));
		VarHandle elemHandle2 = structLayout.varHandle(double.class, PathElement.groupElement("elem2"));
