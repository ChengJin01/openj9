...
public class VaListTests {
	...
	public void test_addIntsWithVaListByUpcallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLibLookup.lookup("addIntsFromVaListByUpcallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
	...
	public void test_addLongsFromVaListByUpcallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLibLookup.lookup("addLongsFromVaListByUpcallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
	...
	public void test_addDoublesFromVaListByUpcallMH() throws Throwable {
		...
		Symbol functionSymbol = nativeLibLookup.lookup("addDoublesFromVaListByUpcallMH").get();
		MethodHandle mh = clinker.downcallHandle(functionSymbol, mt, fd);
