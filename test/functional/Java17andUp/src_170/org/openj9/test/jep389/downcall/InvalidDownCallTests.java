...
public class InvalidDownCallTests {
	...
	public void test_structArgument_nullValue() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact(structSegmt1, null);
	...
	public void test_structArgument_nullSegment() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			MemorySegment resultSegmt = (MemorySegment)mh.invokeExact(structSegmt1, MemorySegment.NULL);
