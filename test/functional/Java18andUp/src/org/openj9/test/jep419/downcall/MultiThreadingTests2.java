...
public class MultiThreadingTests2 implements Thread.UncaughtExceptionHandler {
	...
	private static final FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS);
	private static final NativeSymbol functionSymbol = SymbolLookup.loaderLookup().lookup("addIntAndIntFromPointer").get();
	private static final MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
