...
public class UpcallMethodHandles {
	...
	static {
		try {
			...
			MH_addIntsFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addIntsFromVaList", methodType(int.class, int.class, MemoryAddress.class)); //$NON-NLS-1$
			MH_addLongsFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addLongsFromVaList", methodType(long.class, int.class, MemoryAddress.class)); //$NON-NLS-1$
			MH_addDoublesFromVaList = lookup.findStatic(UpcallMethodHandles.class, "addDoublesFromVaList", methodType(double.class, int.class, MemoryAddress.class)); //$NON-NLS-1$
	...
	public static Addressable addBoolAndBoolFromPtrWithOr_RetPtr(boolean boolArg1, MemoryAddress boolArg2Addr) {
		boolean result = boolArg1 || boolArg2Addr.get(JAVA_BOOLEAN, 0);
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_BOOLEAN, resourceScope);
	...
	public static int addIntsFromVaList(int intCount, MemoryAddress intVaListAddr) {
		VaList intVaList = VaList.ofAddress(intVaListAddr, resourceScope);
		int intSum = 0;
		while (intCount > 0) {
	...
	public static long addLongsFromVaList(int longCount, MemoryAddress longVaListAddr) {
		VaList longVaList = VaList.ofAddress(longVaListAddr, resourceScope);
		long longSum = 0;
		while (longCount > 0) {
	...
	public static double addDoublesFromVaList(int doubleCount, MemoryAddress doubleVaListAddr) {
		VaList doubleVaList = VaList.ofAddress(doubleVaListAddr, resourceScope);
		double doubleSum = 0;
		while (doubleCount > 0) {
	...
	public static MemorySegment add2BoolStructsWithXor_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment boolStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static MemorySegment add3BoolStructsWithXor_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		GroupLayout structLayout = MemoryLayout.structLayout(JAVA_BOOLEAN.withName("elem1"), JAVA_BOOLEAN.withName("elem2"), JAVA_BOOLEAN.withName("elem3"), MemoryLayout.paddingLayout(JAVA_BOOLEAN.bitSize()));
		MemorySegment boolStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);		
		boolean boolStruct_Elem1 = arg1.get(JAVA_BOOLEAN, 0) ^ arg2.get(JAVA_BOOLEAN, 0);
		boolean boolStruct_Elem2 = arg1.get(JAVA_BOOLEAN, 1) ^ arg2.get(JAVA_BOOLEAN, 1);
	...
	public static MemorySegment add2ByteStructs_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment byteStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static MemorySegment add2CharStructs_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment charStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static MemorySegment add2ShortStructs_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment shortStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static MemorySegment add2IntStructs_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment intStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static MemorySegment add2LongStructs_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment longStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static MemorySegment add2FloatStructs_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment floatStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static MemorySegment add2DoubleStructs_returnStruct(MemorySegment arg1, MemorySegment arg2) {
		...
		MemorySegment doubleStructSegmt = MemorySegment.allocateNative(structLayout, resourceScope);
	...
	public static double addDoubleAndIntDoubleFromStruct(double arg1, MemorySegment arg2) {
		...
		//
		double structElem2 = (isAixOS) ? arg2.get(JAVA_DOUBLE, 4) : arg2.get(JAVA_DOUBLE, 8);
	...
	public static long addLongAndFloatLongFromStruct(long arg1, MemorySegment arg2) {
		...
		// The size of [float, long] on AIX/PPC 64-bit is 12 bytes without padding by default
		// while the same struct is 16 bytes with padding on other platforms.
		long structElem2 = (isAixOS) ? arg2.get(JAVA_LONG, 4) : arg2.get(JAVA_LONG, 8);
