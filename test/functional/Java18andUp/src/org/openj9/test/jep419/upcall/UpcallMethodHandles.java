...
*/
	...
	public static boolean addBoolAndBoolFromPointerWithOr(boolean boolArg1, MemoryAddress boolArg2Addr) {
		boolean result = boolArg1 || byteToBool(boolArg2Addr.get(JAVA_BYTE, 0));
		return result;
	}

	public static Addressable addBoolAndBoolFromPtrWithOr_RetPtr(boolean boolArg1, MemoryAddress boolArg2Addr) {
		boolean result = boolArg1 || byteToBool(boolArg2Addr.get(JAVA_BYTE, 0));
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_BYTE.byteSize(), resourceScope);
		resultSegmt.set(JAVA_BYTE, 0, boolToByte(result));
	...
	public static Addressable addBoolAndBoolFromPtrWithOr_RetArgPtr(boolean boolArg1, MemoryAddress boolArg2Addr) {
		boolean result = boolArg1 || byteToBool(boolArg2Addr.get(JAVA_BYTE, 0));
		boolArg2Addr.set(JAVA_BYTE, 0, boolToByte(result));
		return boolArg2Addr;
	}
	...
	public static Addressable createNewCharFromCharAndCharFromPtr_RetPtr(MemoryAddress charArg1Addr, char charArg2) {
		...
		diff = (diff > 5) ? 5 : diff;
		char result = (char)(diff + 'A');
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_CHAR.byteSize(), resourceScope);
	...
	public static Addressable addShortAndShortFromPtr_RetPtr(MemoryAddress shortArg1Addr, short shortArg2) {
		short shortArg1 = shortArg1Addr.get(JAVA_SHORT, 0);
		short shortSum = (short)(shortArg1 + shortArg2);
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_SHORT.byteSize(), resourceScope);
	...
	public static Addressable addIntAndIntFromPtr_RetPtr(int intArg1, MemoryAddress intArg2Addr) {
		int intArg2 = intArg2Addr.get(JAVA_INT, 0);
		int intSum = intArg1 + intArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_INT.byteSize(), resourceScope);
	...
	public static Addressable addLongAndLongFromPtr_RetPtr(MemoryAddress longArg1Addr, long longArg2) {
		long longArg1 = longArg1Addr.get(JAVA_LONG, 0);
		long longSum = longArg1 + longArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_LONG.byteSize(), resourceScope);
	...
	public static Addressable addFloatAndFloatFromPtr_RetPtr(float floatArg1, MemoryAddress floatArg2Addr) {
		float floatArg2 = floatArg2Addr.get(JAVA_FLOAT, 0);
		float floatSum = floatArg1 + floatArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_FLOAT.byteSize(), resourceScope);
	...
	public static Addressable addDoubleAndDoubleFromPtr_RetPtr(MemoryAddress doubleArg1Addr, double doubleArg2) {
		double doubleArg1 = doubleArg1Addr.get(JAVA_DOUBLE, 0);
		double doubleSum = doubleArg1 + doubleArg2;
		MemorySegment resultSegmt = MemorySegment.allocateNative(JAVA_DOUBLE.byteSize(), resourceScope);
...
/*
	...
	public static boolean addBoolFromPointerAndBoolsFromStructWithXor(MemoryAddress arg1Addr, MemorySegment arg2) {
		...
		boolean boolSum = byteToBool(arg1) ^ (boolean)elemHandle1.get(arg2) ^ (boolean)elemHandle2.get(arg2);
		return boolSum;
	}
	...
	public static MemoryAddress addBoolFromPointerAndBoolsFromStructWithXor_returnBoolPointer(MemoryAddress arg1Addr, MemorySegment arg2) {
		...
		int arg1 = MemoryAccess.getIntAtOffset(MemorySegment.allocateNative(), arg1Addr.toRawLongValue());
		boolean boolSum = byteToBool(arg1) ^ (boolean)elemHandle1.get(arg2) ^ (boolean)elemHandle2.get(arg2);
		MemoryAccess.setIntAtOffset(MemorySegment.allocateNative(), arg1Addr.toRawLongValue(), boolToByte(boolSum));
		return arg1Addr;
	}
	...
	public static boolean addBoolAndBoolsFromNestedStructWithXor(boolean arg1, MemorySegment arg2) {
		...
		boolean nestedStructElem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 0));
		boolean nestedStructElem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 4));
		boolean structElem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 8));
	...
	public static boolean addBoolAndBoolsFromNestedStructWithXor_reverseOrder(boolean arg1, MemorySegment arg2) {
		...
		boolean structElem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 0));
		boolean nestedStructElem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 4));
		boolean nestedStructElem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 8));
	...
	public static boolean addBoolAndBoolsFromStructWithNestedBoolArray(boolean arg1, MemorySegment arg2) {
		...
		boolean nestedBoolArrayElem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 0));
		boolean nestedBoolArrayElem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 4));
		boolean structElem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 8));
	...
	public static boolean addBoolAndBoolsFromStructWithNestedBoolArray_reverseOrder(boolean arg1, MemorySegment arg2) {
		...
		boolean structElem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 0));
		boolean nestedBoolArrayElem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 4));
		boolean nestedBoolArrayElem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 8));
	...
	public static boolean addBoolAndBoolsFromStructWithNestedStructArray(boolean arg1, MemorySegment arg2) {
		...
		boolean nestedStructArrayElem1_Elem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 0));
		boolean nestedStructArrayElem1_Elem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 4));
		boolean nestedStructArrayElem2_Elem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 8));
		boolean nestedStructArrayElem2_Elem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 12));
		boolean structElem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 16));
	...
	public static boolean addBoolAndBoolsFromStructWithNestedStructArray_reverseOrder(boolean arg1, MemorySegment arg2) {
		...
		boolean structElem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 0));
		boolean nestedStructArrayElem1_Elem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 4));
		boolean nestedStructArrayElem1_Elem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 8));
		boolean nestedStructArrayElem2_Elem1 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 12));
		boolean nestedStructArrayElem2_Elem2 = byteToBool(MemoryAccess.getIntAtOffset(arg2, 16));
