...
/**
 * Test cases for JEP 419: Foreign Linker API (Second Incubator) for the vararg list in upcall.
 */
...
public class UpcallTests {
	...
	public void test_addIntsWithVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addIntsFromVaList,
	...
	public void test_addLongsFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addLongsFromVaList,
	...
	public void test_addDoublesFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addDoublesFromVaList,
	...
	public void test_addMixedArgsFromVaListByUpcallMH() throws Throwable {
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addMixedArgsFromVaListByUpcallMH").get();
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addMixedArgsFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, ADDRESS), scope);
	...
	public void test_addMoreMixedArgsFromVaListByUpcallMH() throws Throwable {
		 ...
		 */
		if (!isLinuxX64) {
			NativeSymbol functionSymbol = nativeLibLookup.lookup("addMoreMixedArgsFromVaListByUpcallMH").get();
			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, ADDRESS, ADDRESS);
			MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
			...
			try (ResourceScope scope = ResourceScope.newConfinedScope()) {
				VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(JAVA_INT, 100)
						...
						.addVarg(JAVA_DOUBLE, 165.2005D), scope);
				NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addMoreMixedArgsFromVaList,
						FunctionDescriptor.of(JAVA_DOUBLE, ADDRESS), scope);
	...
	public void test_addIntsByPtrFromVaListByUpcallMH() throws Throwable {
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addIntsByPtrFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addIntsByPtrFromVaList,
					FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_addLongsByPtrFromVaListByUpcallMH() throws Throwable {
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addLongsByPtrFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addLongsByPtrFromVaList,
					FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS), scope);
	...
	public void test_addDoublesByPtrFromVaListByUpcallMH() throws Throwable {
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addDoublesByPtrFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addDoublesByPtrFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS), scope);
	...
	public void test_add1ByteOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		if (!isLinuxX64 && !isLinuxAarch64 && !isWinX64) {
			...
			NativeSymbol functionSymbol = nativeLibLookup.lookup("add1ByteOfStructsFromVaListByUpcallMH").get();
			...
			try (ResourceScope scope = ResourceScope.newConfinedScope()) {
					...
					VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
							...
							.addVarg(structLayout, structSegmt10), scope);
				NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add1ByteOfStructsFromVaList,
						FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS), scope);
	...
	public void test_add2BytesOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		if (!isWinX64) {
			...
			NativeSymbol functionSymbol = nativeLibLookup.lookup("add2BytesOfStructsFromVaListByUpcallMH").get();
			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS, ADDRESS);
			MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
			...
			try (ResourceScope scope = ResourceScope.newConfinedScope()) {
				...
				NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add2BytesOfStructsFromVaList,
						FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS), scope);
	...
	public void test_add3BytesOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add3BytesOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add3BytesOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS), scope);
	...
	public void test_add5BytesOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add5BytesOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add5BytesOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS), scope);
	...
	public void test_add7BytesOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add7BytesOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add7BytesOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_BYTE, JAVA_INT, ADDRESS), scope);
	...
	public void test_add1ShortOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		if (!isLinuxX64 && !isLinuxAarch64 && !isWinX64) {
			...
			NativeSymbol functionSymbol = nativeLibLookup.lookup("add1ShortOfStructsFromVaListByUpcallMH").get();
			...
			try (ResourceScope scope = ResourceScope.newConfinedScope()) {
				...
				VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
						...
						.addVarg(structLayout, structSegmt9)
						.addVarg(structLayout, structSegmt10), scope);
				NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add1ShortOfStructsFromVaList,
						FunctionDescriptor.of(JAVA_SHORT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add2ShortsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		if (!isWinX64) {
			...
			NativeSymbol functionSymbol = nativeLibLookup.lookup("add2ShortsOfStructsFromVaListByUpcallMH").get();
			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_SHORT, JAVA_INT, ADDRESS, ADDRESS);
			MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
			...
			try (ResourceScope scope = ResourceScope.newConfinedScope()) {
				...
				VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
						.addVarg(structLayout, structSegmt2), scope);
				NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add2ShortsOfStructsFromVaList,
						FunctionDescriptor.of(JAVA_SHORT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add3ShortsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add3ShortsOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_SHORT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add3ShortsOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_SHORT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add1IntOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		if (!isLinuxX64 && !isLinuxAarch64 && !isWinX64) {
			...
			NativeSymbol functionSymbol = nativeLibLookup.lookup("add1IntOfStructsFromVaListByUpcallMH").get();
			FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS);
			MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
			...
			try (ResourceScope scope = ResourceScope.newConfinedScope()) {
				...
				VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
						...
						.addVarg(structLayout, structSegmt9)
						.addVarg(structLayout, structSegmt10), scope);
				NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add1IntOfStructsFromVaList,
						FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add2IntsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add2IntsOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add2IntsOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add3IntsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add3IntsOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add3IntsOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add2LongsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add2LongsOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add2LongsOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS), scope);
	...
	public void test_add1FloatOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		if (!isWinX64) {
			...
			NativeSymbol functionSymbol = nativeLibLookup.lookup("add1FloatOfStructsFromVaListByUpcallMH").get();
			...
			try (ResourceScope scope = ResourceScope.newConfinedScope()) {
				...
				VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
						...
						.addVarg(structLayout, structSegmt3)
						.addVarg(structLayout, structSegmt4)
						.addVarg(structLayout, structSegmt5), scope);
				NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add1FloatOfStructsFromVaList,
						FunctionDescriptor.of(JAVA_FLOAT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add2FloatsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add2FloatsOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_FLOAT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					...
					.addVarg(structLayout, structSegmt4)
					.addVarg(structLayout, structSegmt5)
					.addVarg(structLayout, structSegmt6), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add2FloatsOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_FLOAT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add3FloatsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add3FloatsOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_FLOAT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					...
					.addVarg(structLayout, structSegmt5)
					.addVarg(structLayout, structSegmt6), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add3FloatsOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_FLOAT, JAVA_INT, ADDRESS), scope);
	...
	public void test_add1DoubleOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add1DoubleOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					...
					.addVarg(structLayout, structSegmt4)
					.addVarg(structLayout, structSegmt5), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add1DoubleOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS), scope);
	...
	public void test_add2DoublesOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("add2DoublesOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_add2DoublesOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS), scope);
	...
	public void test_addIntShortOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addIntShortOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2)
					.addVarg(structLayout, structSegmt3), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addIntShortOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_addShortIntOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addShortIntOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2)
					.addVarg(structLayout, structSegmt3), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addShortIntOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_addIntLongOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addIntLongOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2)
					.addVarg(structLayout, structSegmt3), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addIntLongOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS), scope);
	...
	public void test_addLongIntOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addLongIntOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2)
					.addVarg(structLayout, structSegmt3), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addLongIntOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS), scope);
	...
	public void test_addFloatDoubleOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addFloatDoubleOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2)
					.addVarg(structLayout, structSegmt3), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addFloatDoubleOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS), scope);
	...
	public void test_addDoubleFloatOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addDoubleFloatOfStructsFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2)
					.addVarg(structLayout, structSegmt3), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(VaListUpcallMethodHandles.MH_addDoubleFloatOfStructsFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS), scope);
