...
public class UpcallTests {
	...
	public void test_addMixedArgsFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(UpcallMethodHandles.MH_addMixedArgsFromVaList,
	...
	public void test_addIntsByPtrFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(UpcallMethodHandles.MH_addIntsByPtrFromVaList,
					FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_addLongsByPtrFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(UpcallMethodHandles.MH_addLongsByPtrFromVaList,
					FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS), scope);
	...
	public void test_addDoublesByPtrFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(UpcallMethodHandles.MH_addDoublesByPtrFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS), scope);
	...
	public void test_addIntsByStructFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addIntsByStructFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			NativeSymbol upcallFuncAddr = clinker.upcallStub(UpcallMethodHandles.MH_addIntsByStructFromVaList,
					FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS), scope);
	...
	public void test_addLongsByStructFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addLongsByStructFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(UpcallMethodHandles.MH_addLongsByStructFromVaList,
					FunctionDescriptor.of(JAVA_LONG, JAVA_INT, ADDRESS), scope);
	...
	public void test_addDoublesByStructFromVaListByUpcallMH() throws Throwable {
		...
		NativeSymbol functionSymbol = nativeLibLookup.lookup("addDoublesByStructFromVaListByUpcallMH").get();
		FunctionDescriptor fd = FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS, ADDRESS);
		MethodHandle mh = clinker.downcallHandle(functionSymbol, fd);
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			VaList vaList = VaList.make(vaListBuilder -> vaListBuilder.addVarg(structLayout, structSegmt1)
					.addVarg(structLayout, structSegmt2), scope);
			NativeSymbol upcallFuncAddr = clinker.upcallStub(UpcallMethodHandles.MH_addDoublesByStructFromVaList,
					FunctionDescriptor.of(JAVA_DOUBLE, JAVA_INT, ADDRESS), scope);
