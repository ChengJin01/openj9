...
public class UpcallTests {
	...
	@Test
	public void test_addMoreMixedArgsFromVaListByUpcallMH() throws Throwable {		/* VaList on Linux/x86_64 in OpenJDK is unable to handle the va_list with
	...
	public void test_add2FloatsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			floatHandle2.set(structSegmt2, 4.45F);
			...
			float result = (float)mh.invoke(2, vaList, upcallFuncAddr);
			Assert.assertEquals(result, 11.11F, 0.01F);
		}
	}
	...
	public void test_add3FloatsOfStructsFromVaListByUpcallMH() throws Throwable {
		...
		try (ResourceScope scope = ResourceScope.newConfinedScope()) {
			...
			floatHandle3.set(structSegmt2, 6.67F);
			...
			float result = (float)mh.invoke(2, vaList, upcallFuncAddr);
			Assert.assertEquals(result, 23.32F, 0.01F);
		}
	}
	...
	public void test_addIntShortOfStructsFromVaListByUpcallMH() throws Throwable {
		GroupLayout structLayout = MemoryLayout.structLayout(JAVA_INT.withName("elem1"), JAVA_SHORT.withName("elem2"));
